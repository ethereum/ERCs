...
Reference implementations and resources are maintained under the [ERC-8183 GitHub organization](https://tinyurl.com/28ffe7l3):

- [base-contracts](https://tinyurl.com/23p978cj) — Reference implementation of ERC-8183.
- [hook-contracts](https://tinyurl.com/2cxunb8v) — Community-maintained collection of hook implementations for different commerce applications, innovations and agent interactions.
