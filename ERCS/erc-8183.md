...
Reference implementations and resources are maintained under the ERC-8183 GitHub organization (https://github.com/erc-8183):

- base-contracts (https://github.com/erc-8183/base-contracts) — Reference implementation of ERC-8183.
- hook-contracts (https://github.com/erc-8183/hook-contracts) — Community-maintained collection of hook implementations for different commerce applications, innovations and agent interactions.

Open for contributions, creative ideas, and improvements from the community.
