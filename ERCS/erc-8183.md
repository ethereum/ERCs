...
Reference implementations and resources are maintained at `https://github.com/erc-8183`:

- `base-contracts` (`https://github.com/erc-8183/base-contracts`) — Reference implementation.
