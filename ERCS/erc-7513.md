...
Ethereum introduces smart contracts revolutionized the blockchain and paved the way for the flourishing ecosystem of decentralized applications (dApps). Also, the concept of non-fungible tokens (NFTs) was introduced through [ERC-721](./erc-721.md), offering a paradigm for ownership verification.
...
Additionally, the implementation of Smart-Manager **SHOULD** inherit from [ERC-1155](./erc-1155.md).
...
This proposal aims to ensure the highest possible compatibility with the existing [ERC-1155](./erc-1155.md) protocol. All functionalities present in [ERC-1155](./erc-1155.md), including [ERC-165](./erc-165.md) detection and Smart-NFT support, are retained. This encompasses compatibility with current NFT trading platforms.
