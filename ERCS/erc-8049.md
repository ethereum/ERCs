...
For the full specification of metadata hooks, see [ERC-XXXX](./erc-hooks.md) (Metadata Hooks). That standard defines the hook function signature `ContractMetadataHook(string,address)` with selector `0xcae9bb7e` for use with this ERC.
