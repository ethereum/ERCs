...
- **Interoperable address**: An address encoded according to [ERC-7930](./erc-7930.md).
...
- `token`: An interoperable address of an [ERC-20](./erc-20.md) token on the chain where the call is made.
...
- `token`: An interoperable address of an [ERC-20](./erc-20.md) token.
