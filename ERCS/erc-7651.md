...
Note that this interface draws from similarly defined functions in the [ERC-721](./erc-721.md) and [ERC-20](./erc-20.md) standards, but is not fully backwards compatible with either.
...
This section is placeholder for further discussion surrounding the misidentification of [ERC-7651](./erc-7651.md) as being either ERC-20 or ERC-721. Namely, discussion surrounding potential security implications of interface misinterpretation need to be thoroughly considered.
