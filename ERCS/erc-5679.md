...
Some implementations of [EIP-721](./erc-721.md) and [EIP-1155](./erc-1155.md)
...
1. Any contract complying with [EIP-20](./erc-20.md) when extended with this EIP,
...
2. Any contract complying with [EIP-721](./erc-721.md) when extended with this EIP,
**MUST** implement the following interface:
...
3. Any contract complying with [EIP-1155](./erc-1155.md) when extended with this EIP,
**MUST** implement the following interface:
...
[EIP-721](./erc-721.md) and [EIP-1155](./erc-1155.md).

7. It's RECOMMENDED for the client to implement [EIP-165](./erc-165.md) identifiers as specified above.
...
2. We have chosen to identify the interface with [EIP-165](./erc-165.md) identifiers each individually,
...
5. We have not add extension for [EIP-777](./erc-777.md) because it already handles Minting and Burning.
