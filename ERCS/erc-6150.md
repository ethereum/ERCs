...
This standard is an extension to [EIP-721](./erc-721.md). It proposes a multi-layer filesystem-like hierarchical NFTs. This standard provides interfaces to get parent NFT or children NFTs and whether NFT is a leaf node or root node, maintaining the hierarchical relationship among them.
...
![Website Hierarchical Structure](../assets/erc-6150/website-hierarchy.png)
...
Every compliant contract must implement this proposal, [EIP-721](./erc-721.md) and [EIP-165](./erc-165.md) interfaces.
...
Implementation: [EIP-6150](../assets/erc-6150/contracts/ERC6150.sol)
