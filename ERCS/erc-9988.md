...
An extension of the [ERC-721 standard](./erc-721.md) to enable [ERC-721](./erc-721.md) tokens to have multiple phases of fractionalisation into [ERC-20](./erc-20.md) like tokens.

This standard introduces a framework allowing [ERC-721](./eip-721) Non-Fungible Tokens (NFTs) to be broken down into phase-based tokens (PB Tokens) representing fractional ownership or states at various lifecycle phases. Unlike standard [ERC-20](./eip-20.md) tokens, PB Tokens within [ERC-9988](./erc-9988.md) accommodate the multifaceted nature of asset transformation, encapsulating phase transitions that reflect changes in the underlying asset's state, form, or value.
