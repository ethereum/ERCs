...
The core of this framework is defined by the `ierc-7625` interface, which extends `ierc-165` to ensure compliance with the Ethereum standard for interface detection.
