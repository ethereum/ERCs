...
The smart contract wallet interface of this ERC is for nft asset management and nft asset approval. It supports the simplenft <!-- TODO --> ERC-X, and [ERC-721](./erc-721.md) is backward compatible with <!-- TODO --> ERC-X, so it can be compatible with the management of all nfts in the existing market.
...
/// @title ERC-7564
/// @dev See https://ercs.ethereum.org/ERCS/erc-7564
