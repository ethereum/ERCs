...
**Smart contracts implementing this ERC MUST implement all of the functions in the [ERC-5516](./erc-5516.md) interface.**

**Smart contracts implementing this ERC MUST implement the [ERC-165](./erc-165.md) `supportsInterface` function and MUST return the constant value `true` if `0xe150bdab` is passed through the `interfaceID` argument.**
...
### [ERC-5516](./erc-5516.md) as certificates

The original idea for this proposal arose from a necessity of emitting on-chain certificates to multiple people. We thought that having to emit one token per account was redundant, and we originally developed a [ERC-1155](./erc-1155.md) partial-compatible implementation.
...
### SBT as a _spinoff_ of [ERC-1155](./erc-1155.md)
...
The [ERC-5516](./erc-5516.md) standard guarantees that event logs emitted by the smart contract will provide enough data to create an accurate record of all current token balances. A database or explorer may listen to events and be able to provide indexed and categorized searches of every [ERC-5516](./erc-5516.md) token in the contract.
...
Multi-owner SBTs can also be issued to a contract account that implements a multi-signature functionality (As recommended in [ERC-4973](./erc-4973.md#exception-handling)).
...
You can find an implementation of this standard [here](../assets/erc-5516/ERC5516.sol).
