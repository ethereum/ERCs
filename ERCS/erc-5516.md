...
**Smart contracts implementing this ERC MUST implement the [ERC-165](./eip-165.md) `supportsInterface` function and MUST return the constant value `true` if `0x85a5f87c` is passed through the `interfaceID` argument.**
