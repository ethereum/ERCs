...
The way to resolve the domain name from a domain name service to an address is specified in [ERC-6821](./erc-6821.md) for the Ethereum Name service, and will be discussed in later ERCs for other name services. 
