...
* **Support other use cases:**
  ...
  * Atomic multi-operations (similar to [EIP-3074](./erc-3074.md)).
...
| maxFeePerGas      | uint256 | max amount of basefee that the `operation` execution is expected to pay. _(Similar to [EIP-1559](./erc-1559.md) `max_fee_per_gas`)_.                        |
| priorityFeePerGas | uint256 | fixed amount of fees that the `operation` execution is expected to pay to the bundler. _(Similar to [EIP-1559](./erc-1559.md) `max_priority_fee_per_gas`)_. |
