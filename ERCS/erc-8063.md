...
- **Deployment**: To create a group, deploy a contract implementing [ERC-20](./eip-20.md), [ERC-5679](./eip-5679.md), and this standard. Initial members are determined by the implementation.
