...
1. **MUST** implement [ERC-20](./erc-20.md)
2. **MUST** implement [ERC-165](./erc-165.md)
...
Following the [ERC-20](./erc-20.md) pattern, each group is its own contract deployment:
...
- [ERC-5679](./erc-5679.md) compliant `mint(address, uint256, bytes)`
...
Implementations that want a single-owner governance model MAY use [ERC-173](./erc-173.md) or [ERC-8023](./erc-8023.md) for standardized ownership.
...
This standard is fully backwards compatible with [ERC-20](./erc-20.md). In fact, **any existing ERC-20 token can be used as a Group** — the standard simply defines how to interpret token balance as membership.
...
- [`ERC8063.sol`](../assets/erc-8063/ERC8063.sol) — Reference implementation with membership helpers
