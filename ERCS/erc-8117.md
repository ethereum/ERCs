...
**Vanity Addresses & CREATE2:** Factories and developers frequently mine addresses with specific zero-heavy prefixes for branding or on-chain identification (e.g., `0x0000000071727De22E5E9d8BAf0edAc6f37da032`, the [ERC-4337](./eip-4337.md) EntryPoint).
...
- The most security-relevant vanity-mined and gas-optimised addresses (e.g., [ERC-4337](./eip-4337.md) EntryPoint at 7 zeros, Uniswap V4 at 11 zeros) are all well above the threshold.
