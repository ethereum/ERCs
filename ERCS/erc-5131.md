...
## Abstract
This EIP links one or more signing wallets via Ethereum Name Service Specification ([EIP-137](./erc-137.md)) to prove control and asset ownership of a main wallet.
