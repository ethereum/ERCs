...
![Single Sandboxed Smart Wallet](../assets/erc-8199/Single-SandboxedSmartWallet.svg)


![Multi Sandboxed Smart Wallet](../assets/erc-8199/Multi-SandboxedSmartWallet.svg)
...
Contracts MAY implement [ERC-165](./erc-165.md).
...
1. The interface of `SandboxedSmartWallet` is kept with only the essentials for agentic operations. The additional capability, e.g., [ERC-4337](./erc-4337.md) based gas abstraction, etc is left untouched for the wallet developers to decide on their preference of the stack.
...
4. Standard interface referencing [ERC-173](./erc-173.md)’s `owner()` is imposed for better compatibility with ownership based tooling/sdks.
...
7. `SandboxedSmartWallet` can optionally impose [ERC-173](./erc-173.md) or [ERC-8023](./erc-8023.md) based ownership mechanism for secure ownership management.
