...
For an improved user experience, the signed data is structured following [EIP-712](./erc-712.md), which already has wide spread adoption in major RPC providers.
