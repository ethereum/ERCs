...
Tests can be found in [`charity.js`](../assets/erc-6353/test/charity.js).

## Reference Implementation

The reference implementation of the standard can be found under [`contracts/`](../assets/erc-6353/contracts/ERC20Charity.sol) folder.
