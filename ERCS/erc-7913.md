...
description: An interface for querying and publishing token safety scores on EVM chains
author: CryptoGen Security (@CryptoGenesisSecurity)
discussions-to: https://ethereum-magicians.org/t/erc-7913-token-safety-score/1
status: Draft
