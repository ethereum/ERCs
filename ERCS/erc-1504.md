...
Since the Upgrader contract in [ERC-1504](./erc-1504.md) has a simple voting mechanism, it is prone to all the limitations that the voting contract is facing:
...
2. [ERC-1504](./erc-1504.md) - a reference implementation
