...
The optional `ERC1155Metadata_URI` extension can be identified with the [ERC-165 Standard Interface Detection](./erc-165.md).
...
**Standards**
- [ERC-721 Non-Fungible Token Standard](./erc-721.md)
- [ERC-165 Standard Interface Detection](./erc-165.md)
- [ERC-1538 Transparent Contract Standard](./erc-1538.md)
