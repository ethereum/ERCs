...
An extension of the [ERC-721 standard](./erc-721.md) to enable ERC-721 tokens to own other ERC-721 tokens and [ERC-20](./erc-20.md) tokens.

An extension of the [ERC-20](./erc-20.md) and `ERC-223 https://github.com/ethereum/EIPs/issues/223` standards to enable ERC-20 and `ERC-223` tokens to be owned by ERC-721 tokens.
...
`ERC998ERC721` top-down, `ERC998ERC20` top-down, and `ERC998ERC721` bottom-up composable contracts must implement the [ERC-721 interface](./erc-721.md).

### ERC-20

`ERC998ERC20` bottom-up composable contracts must implement the [ERC-20 interface](./erc-20.md).

### [ERC-165](./erc-165.md)

The [ERC-165 standard](./erc-165.md) must be applied to each [ERC-998](./erc-998.md) interface that is used.
...
/// @dev See https://github.com/ethereum/EIPs/blob/master/EIPS/erc-998.md
