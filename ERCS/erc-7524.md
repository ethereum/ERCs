...
[Mina relied] on [^2] before the hashing to curve [IETF RFC 9380] was finished, and the approach they use is vetted with the value locked in the system. DST [should be incorporated in a message](https://www.o1labs.org/blog/the-many-saints-of-privacy-nullifiers-in-o1js#nullifiers-line-by-line) as noted above.
...
[Mina relied]: issue #756 in `o1-labs/o1js` Github repo
