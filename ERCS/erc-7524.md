...
#### BN254
(the curve parameters are at `noir_bigcurve` repo in `noir-lang` on Github)

**Hash:** Poseidon-2 as defined for Barretenberg proof system.

##### Hash-to-curve parameters

This one is made by José Pedro Sousa. It omits `expand_message` step -- see the DST incorporation notice above. 
