...
This standard is an extension of [ERC-721](./erc-721.md). It proposes a way to maintain hierarchical relationship between tokens from different contracts. This standard provides an interface to query the parent tokens of an NFT or whether the parent relation exists between two NFTs.
...
This standard differs from [ERC-6150](./erc-6150.md) in mainly two aspects: supporting cross-contract token reference, and allowing multiple parents. But we try to keep the naming consistent overall.
...
Test cases available at: [`ERC7510.test.ts`](../assets/erc-7510/test/ERC7510.test.ts):
...
Reference implementation available at: [`ERC7510.sol`](../assets/erc-7510/contracts/ERC7510.sol):
