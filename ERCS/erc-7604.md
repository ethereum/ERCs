...
The "permit" approval flow for both [ERC-20](./erc-4494.md) and [ERC-2612](./erc-2612.md)  are large improvements for the existing UX of the token underlying each ERC. This ERC extends the "permit" pattern to [ERC-1155](./erc-20.md) tokens, borrowing heavily upon both [ERC-4494](./erc-4494.md) and [ERC-2612](./erc-2612.md).
...
The permit structures outlined in both [ERC-4494](./erc-4494) and [ERC-2612](./erc-2612) allows a signed message to create an approval, but are only applicable to their respective underlying tokens (ERC-721 and ERC-20).
