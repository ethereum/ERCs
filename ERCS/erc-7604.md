...
The structure of [ERC-1155](./erc-1155.md) tokens requires a new ERC to account for the token standard's use of both token IDs and balances (also why this ERC requires [ERC-5216](./erc-5216.md)).

## Motivation

The permit structures outlined in both [ERC-4494](./erc-4494.md) and [ERC-2612](./erc-2612.md) allows a signed message to create an approval, but are only applicable to their respective underlying tokens ([ERC-721](./erc-721.md) and [ERC-20](./erc-20.md)).
