...
EIP-712 typed messages are included because of its use in [ERC-4494](https://github.com/ethereum/ercs/blob/master/ERCS/erc-4494.md) and [ERC-2612](https://github.com/ethereum/ercs/blob/master/ERCS/erc-2612.md), which in turn cites widespread adoption in many wallet providers.
