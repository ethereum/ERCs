...
This proposal aims to extend the functionality of the existing [ERC-2612](./erc-2612.md) Permit to support gasless [ERC-20](./erc-20.md) approval operations initiated by smart contract wallets. 
