...
This ERC does not replace [ERC-20](./erc-20.md), [ERC-721](./erc-721.md), or [ERC-1155](./erc-1155.md). A compliant contract implements this ERC in addition to at least one base token standard.

- [ERC-20](./erc-20.md): Each unit represents a standardized fraction, such as 1e18 units representing one metric tonne of carbon dioxide equivalent (tCO2e).
- [ERC-721](./erc-721.md): Single credit with unique `esgURI` and immutable metadata.
- [ERC-1155](./erc-1155.md): Homogeneous batch with common URI, metadata, and fungible amounts.
