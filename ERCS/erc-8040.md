...
- [./eip-20.md]: Each unit represents a standardized fraction (e.g., 1e18 = 1 tCO2e).
- [./eip-721.md]: Single credit with unique esgURI and immutable metadata.
- [./eip-1155.md]: Homogeneous batch with common URI, metadata, and fungible amounts.
