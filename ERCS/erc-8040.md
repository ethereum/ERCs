  ...
  "params": [
    {
      ...
      "data": "0x..." // Encoded call data for the function
    }
  ],
  "id": 1
}
...
4. **Post-Quantum Cryptography**: Hash functions SHOULD be quantum-resistant. Quantum-resistant signature schemes MAY be used for off-chain attestations, but are not currently required or implementable for on-chain signatures.
