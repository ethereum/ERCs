...
In the folder at [assets folder](../assets/eip-7656/) there are a few more examples of services (a social recovery for [ERC-4437](./eip-4337.md) accounts, a revenue share services for NFTs and a Real World Asset Management service for NFTs).
