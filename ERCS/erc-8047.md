...
discussions-to: https://ethereum-magicians.org/t/eip-8047-forensic-token-forest/25786
status: Draft
...
<div align="center">
  <img alt="mint" src="../assets/eip-8047/erc8047-mint.svg" width="320"/>
</div>
...
<div align="center">
  <img alt="partial spend" src="../assets/eip-8047/erc8047-partial-spend.svg" width="320"/>
</div>
...
<div align="center">
  <img alt="full spend" src="../assets/eip-8047/erc8047-full-spend.svg" width="320"/>
</div>

Full Spend Events emitted:

- TokenSpent(01, 01, 1000)
- TokenCreated(01, 01A, spender)
- TransferSingle(operator, Alice, zero_address, 01, 1000)
- TransferSingle(operator, zero_address, Bob, 01A, 1000)
...
<div align="center">
  <img alt="partial burn" src="../assets/eip-8047/erc8047-partial-burn.svg" height="160"/>
</div>

Partial Burn Events emitted:

- TokenSpent(01, 01, 500)
- TransferSingle(operator, spender, zero_address, 01, 500)
...
<div align="center">
  <img alt="full burn" src="../assets/eip-8047/erc8047-full-burn.svg" height="160"/>
</div>

Full Burn Events emitted:

- TokenSpent(#A1, 01, 1000)
- TransferSingle(operator, from, zero_address, 01, 1000)
