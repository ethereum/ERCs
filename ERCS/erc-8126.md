...
**ERC-3009 (Transfer With Authorization)**: Verification fees are paid via [ERC-3009](./eip-3009.md), which enables gasless USDC transfers, with the provider covering gas costs, making verification accessible without requiring users to hold ETH.
...
- Uses [AES-256-GCM](https://nvlpubs.nist.gov/nistpubs/legacy/sp/nistspecialpublication800-38d.pdf) or equivalent post-quantum encryption algorithm
...
The reference implementation at [ERC-8126scan](https://erc8126scan.ai) demonstrates:
...
- **Circuit Soundness**: Implementations should use audited circuits (e.g., [Groth16](https://computingonline.net/computing/article/view/4329)) with formal security proofs
