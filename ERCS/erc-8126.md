...
- SHOULD follow the OWASP Smart Contract Security Verification Standard (SCSVS)
...
- MUST produce a risk score between 0 and 100
- SHOULD follow the OWASP Web Security Testing Guide (WSTG)
- SHOULD follow the OWASP Top 10
