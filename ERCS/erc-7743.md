...
The full reference implementation code for the MO-NFT standard is included in the EIPs repository under [`assets/erc-7743`](../assets/erc-7743). This ensures the code is preserved alongside the EIP and remains accessible.
...
- **IERC721 and ERC165**: Ensures compliance with the [ERC-721](./eip-721.md) standard.
...
- [`MONFT.sol`](../assets/erc-7743/MONFT.sol)

- [`DigitalAsset.sol`](../assets/erc-7743/DigitalAsset.sol)

- [`IDigitalAsset.sol`](../assets/erc-7743/IDigitalAsset.sol)
