...
The MO-NFT standard is designed to be compatible with the [ERC-721](./erc-721.md) standard. It implements required functions such as `balanceOf`, `ownerOf`, and `transferFrom` from the `ERC721` interface.
