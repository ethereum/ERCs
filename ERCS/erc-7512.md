...
- Contract
    - `chainId`: MUST be a `bytes32` representation of the [EIP-155](https://eips.ethereum.org/EIPS/eip-155) chain ID of the blockchain that the contract has been deployed in
...
- Why [EIP-712](https://eips.ethereum.org/EIPS/eip-712)?
    - [EIP-712](https://eips.ethereum.org/EIPS/eip-712) was chosen as a base due to its tooling compatibility (i.e. for signing)
