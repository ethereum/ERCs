...
External Dependencies: The manifest SHOULD identify any expected calls to external contracts, specifically emphasizing DELEGATECALL requirements.

EVM Compatibility: The manifest SHOULD specify required EIP capabilities (e.g., [EIP-3855](./eip-3855.md) for PUSH0 support, [EIP-7939](./eip-7939.md) for CLZ support) to prevent deployment on incompatible chains.
...
Related tooling is expected to independently verify opcode compatibility and storage impact through static analysis of the runtime bytecode, as manifest signaling is considered "optimistic" and unverified.
