...
EVM Compatibility: The manifest SHOULD specify required EIP capabilities (e.g., EIP-3855 for PUSH0 support, EIP-7939 for CLZ support) to prevent deployment on incompatible chains.
