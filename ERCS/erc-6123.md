...
Live-cycle unit tests based on the sample implementation and usage of [EIP-20](./erc-20.md) token is provided. See file [test/SDC.js](../assets/eip-6123/test/SDC.js)
).
