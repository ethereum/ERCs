...
A full example implementation including [interfaces](../assets/erc-4987/IERC721Holder.sol), a vault [token holder](../assets/erc-4987/Vault.sol), and a [consumer](../assets/erc-4987/Consumer.sol), can be found at `assets/eip-4987/`.
