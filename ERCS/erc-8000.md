...
**Every [ERC-8000](./eip-8000.md)compliant contract must implement the [ERC-721](./eip-721.md) and [ERC-165](./eip-165.md) interfaces** :
...
This is the "[ERC-8000](./eip-8000.md) Metadata JSON Schema for contractURI()" referenced above.
...
This is the "[ERC-8000](./eip-8000.md) Metadata JSON Schema for slotURI(uint)" referenced above.
...
We chose Standard Interface Detection ([ERC-165](./eip-165.md)) to expose the interfaces that a [ERC-8000](./eip-8000.md) smart contract supports.
