...
This behavior fits well with the usage of the \_msgSender() function from [ERC-2771](./erc-2771.md).
...
Worth noting that the usage of transient storage ([EIP-1153](https://eips.ethereum.org/EIPS/eip-1153)) for storing the `msg.sender` is highly RECOMMENDED.
