...
description: This is the standard for Multi-Fungible Tokens (MFT). The provided document describes the smart contract interface set
...
**Every ERC8000 compliant contract must implement the `[ERC-721](./erc-721.md)` and `[ERC-165](./erc-165.md)` interfaces** :
