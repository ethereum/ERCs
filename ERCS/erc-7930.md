...
- MAY add syntactic restrictions to the _Interoperable Name_ definition but MUST ensure that any binary data derived from such name resolution strictly conforms to the _Interoperable Address_ encoding defined in this specification.
