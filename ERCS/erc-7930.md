...
- Using `<>` as the separator ensures Interoperable Names can't be confused with email addresses.
...
### Example 5: Arbitrum One address
Chain: Ethereum Mainnet
Address: `0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045`
  ...
  ^^^^---------------------------------------------------- Version:              decimal 1
      ^^^^------------------------------------------------ ChainType:            2 bytes of CAIP namespace
          ^^---------------------------------------------- ChainReferenceLength: decimal 2
            ^^^^------------------------------------------ ChainReference:       2 byte to store uint16(42161)
                ^^---------------------------------------- AddressLength:        decimal 20
                  ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ Address:              20 bytes of ethereum address
```
