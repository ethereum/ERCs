...
: An address representation that includes both the _target address_ **and** the chain being targeted. An _Interoperable Address_ is an example of a chain specific address.
