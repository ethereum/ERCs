...
This EIP introduces the `evalEIP712Buffer` function, which takes an [EIP-712](https://eips.ethereum.org/EIPS/eip-712) buffer and returns a human-readable text description.
