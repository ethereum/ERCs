...
/**
    @title Upgradable Fungible Token
    @dev See https://ercs.ethereum.org/ERCS/erc-6864
 */
...
The **see-through extension** is OPTIONAL. It allows for easy viewing of combined states between this [ERC-6864](./erc-6864.md) and base ERC-20 smart contracts.
