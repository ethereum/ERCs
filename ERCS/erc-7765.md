...
/// @dev See https://ercs.ethereum.org/ERCS/erc-7765
...
The **metadata extension** is OPTIONAL for [EIP-7765](./erc-7765.md) smart contracts. This allows your smart contract to be interrogated for its details about the privileges which your NFTs carry.
