...
![Diagram showing how a diamond contract works](../assets/erc-8153/basic-diamond-diagram.svg)

Diamond contracts were originally standardized by [ERC-2535](./erc-2535.md). This ERC builds on that foundation by defining a facet-based architecture in which facets self-describe their function selectors through a standardized introspection interface.
...
![Diagram showing structure of a diamond](../assets/erc-8153/functionFacetMapping.svg)
...
An [ERC-8153](./erc-8153.md) diamond MUST implement the same introspection functions as defined in ERC-2535.
