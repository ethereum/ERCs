...
2. **Asset Transfer:**
   ...
   - The user sends assets (e.g., ERC20 tokens or native currency) to the generated ISA address.
...
- **EIP-7683 (Cross-Chain Intents):** ISA supports interaction paradigms that abstract user intent across chains.
