---
eip: 8259
title: AI Agent Identity & Threat Registry
description: Decentralized identity, reputation, and threat intelligence sharing for AI agents
...
This EIP proposes a standardized framework for decentralized identity (DID) management, reputation
scoring, and threat intelligence sharing for AI agents operating across Ethereum-based DeFi
protocols. The standard defines interfaces for AI agent registration, multi-tier verification
systems, cross-protocol reputation tracking, and collaborative threat detection. It enables AI
agents to build portable reputations while allowing protocols to share security intelligence in a
...
Current solutions are protocol-specific and don't enable collaborative security. This standard
addresses these challenges by creating:
...
- **[ERC-165](./eip-165.md)**: Implements standard interface detection
- **[ERC-721](./eip-721.md)**: Compatible with NFT-based identities  
- **[ERC-1155](./eip-1155.md)**: Supports multi-token identity systems
...
- `AgentIdentityRegistry.vy`
- `ThreatRegistry.vy`
- `Hogonat.vy`
- `CompoundSiguiAdapter.vy`
