...
A set of functions to enable meta-transactions and atomic interactions with [ERC-20](./erc-20.md) token contracts via signatures conforming to the [EIP-712](./eip-712.md) typed message signing specification.
