...
New contracts benefit from being able to directly utilize [ERC-3009](./erc-3009.md) in order to create atomic transactions, but existing contracts may still rely on the conventional ERC-20 allowance pattern (`approve`/`transferFrom`).
