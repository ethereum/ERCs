...
This proposal builds on [EIP-712](./eip-712.md) and complements [ERC-7683](../ERCS/erc-7683.md) and [ERC-7521](../ERCS/erc-7521.md). [ERC-8001](../ERCS/erc-8001.md) defines a secure framework for direct agent-to-agent coordination in decentralized environments. The Core specification provides cryptographically secure intent semantics with multi-party consensus, while maintaining [EIP-712](./eip-712.md) compatibility for wallet and agent integration. Optional modules extend functionality with enhanced security, batch execution, and cross-chain coordination. This enables autonomous agents in DeFi, MEV search, cross-chain arbitrage, and market making to coordinate securely without trusted intermediaries.
...
While [ERC-7683](../ERCS/erc-7683.md) addresses user-initiated cross-chain intents and [ERC-7521](../ERCS/erc-7521.md) handles transfer-centric scenarios, neither provides the multi-party consensus and agent-specific features required for autonomous agent coordination.

[ERC-8001](../ERCS/erc-8001.md) addresses these gaps by providing:
...
3. **Complementary to existing ERCs**: Can be used alongside [ERC-7683](../ERCS/erc-7683.md), [ERC-7521](../ERCS/erc-7521.md), and other intent standards
