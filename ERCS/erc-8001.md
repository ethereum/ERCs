...
While [ERC-7683](./erc-7683.md) addresses user-initiated cross-chain intents and [ERC-7521](./erc-7521.md) handles transfer-centric scenarios, neither provides the multi-party consensus and agent-specific features required for autonomous agent coordination.
...
3. **Complementary to existing ERCs**: Can be used alongside [ERC-7683](./erc-7683.md), [ERC-7521](./erc-7521.md), and other intent standards
