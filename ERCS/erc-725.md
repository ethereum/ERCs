...
**`ERC725X`** interface id according to [ERC-165](./erc-165.md): `0x7545acac`.

Smart contracts implementing the `ERC725X` standard MUST implement the [ERC-165](./erc-165.md) `supportsInterface(..)` function and MUST support the `ERC165` and `ERC725X` interface ids.
...
> See [EIP-1014: Skinny CREATE2](./erc-1014.md) for more information.
...
**`ERC725Y`** interface id according to [ERC-165](./erc-165.md): `0x629aa694`.

Smart contracts implementing the `ERC725Y` standard MUST implement the [ERC-165](./erc-165.md) `supportsInterface(..)` function and MUST support the `ERC165` and `ERC725Y` interface ids.
