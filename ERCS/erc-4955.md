...
This EIP standardizes a schema for NFTs metadata to add new field namespaces to the JSON schema for [EIP-721](./erc-721.md) and [EIP-1155](./erc-1155.md) NFTs.
...
![](../assets/erc-4955/different-renders.jpeg)
...
The same security considerations as with [EIP-721](./erc-721.md) apply related to using http gateways or IPFS for the tokenURI method.
