...
1. An [ERC-165](./erc-165.md) discoverable interface (`IIntentSpec`) exposing a metadata URI.
...
This ERC is complementary to [ERC-8004](./erc-8004.md).

[ERC-8004](./erc-8004.md) defines infrastructure primitives for autonomous agents, including identity, reputation, and validation mechanisms. It standardizes how agents establish identity and trust.
...
Contracts implementing this standard **MUST** support [ERC-165](./erc-165.md) interface detection as defined in [ERC-165](./erc-165.md).
