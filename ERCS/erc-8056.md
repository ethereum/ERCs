...
### Optional Extension: Transfer Events

Contracts MAY implement the `IScaledUIAmountTransfer` extension to emit UI amounts during transfers:

```solidity
interface IScaledUIAmountTransfer {
    // Emitted during a token transfer with the UI-adjusted amount
...
- `IScaledUIAmount`: `0xTBD`
- `IScaledUIAmountConversion`: `0xTBD`
- `IScaledUIAmountBalances`: `0xTBD`
- `IScaledUIAmountTransfer`: `0xTBD`
    ...
    Ownable
{
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override returns (bool) {
        return
            ...
            interfaceId == type(IScaledUIAmountTransfer).interfaceId ||
    ...
    // ============ Optional: Transfer Events Extension ============
...
const ISCALED_UI_AMOUNT_ID = "0xTBD";
const ISCALED_UI_BALANCES_ID = "0xTBD";
