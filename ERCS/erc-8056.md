...
Tokens MUST implement the following interface to expose a pending UI multiplier that has been scheduled but has not yet taken effect:
...
```solidity
contract ScaledUIToken is ERC20, IScaledUIAmount, IScaledUIAmountNewUIMultiplier, Ownable {
