...
Compliant contracts MUST implement [ERC-165](./erc-165.md) and return `true` when queried for the `IScaledUIAmount` interface ID.
...
1. ERC-165 Support: Compliant contracts MUST implement [ERC-165](./erc-165.md) interface detection.
