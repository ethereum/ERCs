...
* Game developers could share an [ERC-1155](./erc-1155.md) contract where each developer manages tokens under a specified scope.
...
**Standards**
- [ERC-1155 Multi Token Standard](./erc-1155.md)
