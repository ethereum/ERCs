...
Contracts using the optional update extension (`IERC8118AgentAuthorizationUpdatable`) should ensure upgrade mechanisms preserve authorization state. When using proxy patterns (ERC-1967, UUPS), the authorization storage slots must remain consistent across implementations.
