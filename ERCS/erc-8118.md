...
- **Cryptographic consent**: Agents must sign consent to being authorized ([EIP-712](https://eips.ethereum.org/EIPS/eip-712))
...
3. For contract agents, the signature MUST be validated using [EIP-1271](https://eips.ethereum.org/EIPS/eip-1271) `isValidSignature`.
...
| Feature | [ERC-4337](https://eips.ethereum.org/EIPS/eip-4337) | [EIP-7702](https://eips.ethereum.org/EIPS/eip-7702) | This ERC |
|---------|----------|----------|----------|
...
**[ERC-6900](https://eips.ethereum.org/EIPS/eip-6900) (Modular Accounts)**
...
**[ERC-7579](https://eips.ethereum.org/EIPS/eip-7579) (Minimal Modular Accounts)**
...
**Token Approvals**: This standard operates independently of ERC-20/[ERC-721](https://eips.ethereum.org/EIPS/eip-721)/[ERC-1155](https://eips.ethereum.org/EIPS/eip-1155) approval mechanisms. An agent authorized via this interface still requires appropriate token approvals for transfers.
...
Contracts using the optional update extension (`IERC8118AgentAuthorizationUpdatable`) should ensure upgrade mechanisms preserve authorization state. When using proxy patterns ([ERC-1967](https://eips.ethereum.org/EIPS/eip-1967), UUPS), the authorization storage slots must remain consistent across implementations.
