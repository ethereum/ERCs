...
In short, this ERC turns verifiable ML inference into a reusable primitive—doing for AI outputs what [ERC-20](./erc-20.md)/[ERC-721](./erc-721.md) did for assets.
...
(e.g., simple owner storage, [ERC-173](https://ercs.ethereum.org/ERCS/erc-173), [ERC-721](https://ercs.ethereum.org/ERCS/erc-173) representation, or role-based control). 
...
- Uses [ERC-165](https://ercs.ethereum.org/ERCS/erc-165) like popular [ERC-721](https://ercs.ethereum.org/ERCS/erc-721) or [ERC-1155](https://ercs.ethereum.org/ERCS/erc-1155) for discoverability.
