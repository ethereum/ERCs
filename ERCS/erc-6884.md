...
The metadata JSON schema follows the same specifications as the metadata schema used in [ERC-721](./erc-721.md).
...
See [reference implementation](../assets/erc-6884/contracts/ERC6884.sol).
