...
This EIP separates the [ERC-721](./erc-721.md) NFT's commercial usage rights from its ownership to allow for the independent management of those rights.
...
This standard is compatible with [ERC-721](./erc-721.md) since it is an extension of it.
