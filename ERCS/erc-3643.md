...
function transfer(address _to, uint256 _amount) public override whenNotPaused returns (bool) {
        ...
        require( _tokenIdentityRegistry.isVerified(_to), "ERC-3643: Invalid identity" );
        require( _tokenCompliance.canTransfer(msg.sender, _to, _amount), "ERC-3643: Compliance failure" );
