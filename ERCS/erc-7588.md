...
This EIP introduces a standard for attaching metadata to blobs carried by blob transactions, as outlined in EIP-4844. The metadata is represented as a JSON object adhering to a predefined schema. It is encoded as a hexadecimal string and placed in the data field of the blob transaction.
