...
- Wallets that manage many accounts, where assets across those accounts can be transferred to the required account before submitting a transaction requested by an app
