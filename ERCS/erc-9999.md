...
This proposal defines a nested [EIP-712](./eip-712.md) typed structure and wrapped signature scheme for [ERC-1271](./eip-1271.md) verification. 
...
The bulk of this standard defines the behavior of the `isValidSignature` function for [ERC-1271](./eip-1271.md). 
