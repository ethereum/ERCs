...
- Interfaces: [`IKYATypes.sol`](../assets/erc-9999/contracts/interfaces/IKYATypes.sol), [`IKYASchemeRegistry.sol`](../assets/erc-9999/contracts/interfaces/IKYASchemeRegistry.sol), [`IKYARegistry.sol`](../assets/erc-9999/contracts/interfaces/IKYARegistry.sol), [`IKYAPolicyRegistry.sol`](../assets/erc-9999/contracts/interfaces/IKYAPolicyRegistry.sol), [`IKYAVerifier.sol`](../assets/erc-9999/contracts/interfaces/IKYAVerifier.sol), and a minimal [`IERC8004Validation.sol`](../assets/erc-9999/contracts/interfaces/IERC8004Validation.sol).
- Registries: [`KYASchemeRegistry.sol`](../assets/erc-9999/contracts/KYASchemeRegistry.sol), [`KYARegistry.sol`](../assets/erc-9999/contracts/KYARegistry.sol), [`KYAPolicyRegistry.sol`](../assets/erc-9999/contracts/KYAPolicyRegistry.sol) — permissionless.
- Bridge: [`KYABridge8004.sol`](../assets/erc-9999/contracts/KYABridge8004.sol) — curated ERC-8004 validator mirroring KYA outcomes.
- Verifier adapter: [`Groth16KYAVerifierAdapter.sol`](../assets/erc-9999/contracts/verifiers/Groth16KYAVerifierAdapter.sol) — adapts a snarkjs-style Groth16 verifier to `IKYAVerifier` using the `kya-public-v1` layout.

Schemas for the scheme, policy and discovery documents: [`kya-scheme.schema.json`](../assets/erc-9999/schemas/kya-scheme.schema.json), [`kya-policy.schema.json`](../assets/erc-9999/schemas/kya-policy.schema.json), [`kya-discovery.schema.json`](../assets/erc-9999/schemas/kya-discovery.schema.json).
