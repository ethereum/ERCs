...
discussions-to: https://ethereum-magicians.org/t/subject-linked-compliance-event-log-candidate-erc/28937
status: Draft
...
actions such as issuance, redemption, freezing, KYC-status changes, regulatory
holds, policy changes, and forced transfers.
...
An original or non-correction event MUST use:
...
bytes32 constant SUBJECT_TOKEN =
    keccak256("ERC-XXXX:SUBJECT_TYPE:TOKEN");
bytes32 constant SUBJECT_ADDRESS =
    keccak256("ERC-XXXX:SUBJECT_TYPE:ADDRESS");
bytes32 constant SUBJECT_ASSET =
    keccak256("ERC-XXXX:SUBJECT_TYPE:ASSET");
bytes32 constant SUBJECT_CASE =
    keccak256("ERC-XXXX:SUBJECT_TYPE:CASE");
```
...
bytes32 constant EVT_ISSUANCE =
    keccak256("ERC-XXXX:EVENT_TYPE:ISSUANCE:V1");
bytes32 constant EVT_TRANSFER =
    keccak256("ERC-XXXX:EVENT_TYPE:TRANSFER:V1");
bytes32 constant EVT_REDEMPTION =
    keccak256("ERC-XXXX:EVENT_TYPE:REDEMPTION:V1");
bytes32 constant EVT_FREEZE =
    keccak256("ERC-XXXX:EVENT_TYPE:FREEZE:V1");
bytes32 constant EVT_UNFREEZE =
    keccak256("ERC-XXXX:EVENT_TYPE:UNFREEZE:V1");
bytes32 constant EVT_FORCED_TRANSFER =
    keccak256("ERC-XXXX:EVENT_TYPE:FORCED_TRANSFER:V1");
bytes32 constant EVT_KYC_APPROVED =
    keccak256("ERC-XXXX:EVENT_TYPE:KYC_APPROVED:V1");
bytes32 constant EVT_KYC_REVOKED =
    keccak256("ERC-XXXX:EVENT_TYPE:KYC_REVOKED:V1");
bytes32 constant EVT_KYC_UPDATED =
    keccak256("ERC-XXXX:EVENT_TYPE:KYC_UPDATED:V1");
bytes32 constant EVT_REGULATORY_HOLD =
    keccak256("ERC-XXXX:EVENT_TYPE:REGULATORY_HOLD:V1");
bytes32 constant EVT_HOLD_RELEASED =
    keccak256("ERC-XXXX:EVENT_TYPE:HOLD_RELEASED:V1");
bytes32 constant EVT_ALLOWLIST_ADDED =
    keccak256("ERC-XXXX:EVENT_TYPE:ALLOWLIST_ADDED:V1");
bytes32 constant EVT_ALLOWLIST_REMOVED =
    keccak256("ERC-XXXX:EVENT_TYPE:ALLOWLIST_REMOVED:V1");
bytes32 constant EVT_POLICY_CHANGE =
    keccak256("ERC-XXXX:EVENT_TYPE:POLICY_CHANGE:V1");
bytes32 constant EVT_CORRECTION =
    keccak256("ERC-XXXX:EVENT_TYPE:CORRECTION:V1");
```
...
bytes32 constant ROLE_SENDER =
    keccak256("ERC-XXXX:PARTY_ROLE:SENDER");
bytes32 constant ROLE_RECEIVER =
    keccak256("ERC-XXXX:PARTY_ROLE:RECEIVER");
bytes32 constant ROLE_TARGET =
    keccak256("ERC-XXXX:PARTY_ROLE:TARGET");
bytes32 constant ROLE_BENEFICIARY =
    keccak256("ERC-XXXX:PARTY_ROLE:BENEFICIARY");
bytes32 constant ROLE_CONTROLLER =
    keccak256("ERC-XXXX:PARTY_ROLE:CONTROLLER");
bytes32 constant ROLE_SUBJECT =
    keccak256("ERC-XXXX:PARTY_ROLE:SUBJECT");
```
...
bytes32 constant OUTCOME_APPROVED =
    keccak256("ERC-XXXX:OUTCOME:APPROVED");
bytes32 constant OUTCOME_DENIED =
    keccak256("ERC-XXXX:OUTCOME:DENIED");
bytes32 constant OUTCOME_PENDING =
    keccak256("ERC-XXXX:OUTCOME:PENDING");
bytes32 constant OUTCOME_EXECUTED =
    keccak256("ERC-XXXX:OUTCOME:EXECUTED");
bytes32 constant OUTCOME_EXPIRED =
    keccak256("ERC-XXXX:OUTCOME:EXPIRED");
bytes32 constant OUTCOME_REVOKED =
    keccak256("ERC-XXXX:OUTCOME:REVOKED");
```
...
bytes32 constant AUTHORITY_INTERNAL_POLICY =
    keccak256("ERC-XXXX:AUTHORITY:INTERNAL_POLICY:V1");
bytes32 constant AUTHORITY_COURT_ORDER =
    keccak256("ERC-XXXX:AUTHORITY:COURT_ORDER:V1");
bytes32 constant AUTHORITY_REGULATOR =
    keccak256("ERC-XXXX:AUTHORITY:REGULATOR:V1");
```
...
bytes32 constant PAYLOAD_TRANSFER_V1 =
    keccak256("ERC-XXXX:PAYLOAD:TRANSFER:V1");
// abi.encode(
//     address from,
//     address to,
//     uint256 amount,
...
bytes32 constant PAYLOAD_FREEZE_V1 =
    keccak256("ERC-XXXX:PAYLOAD:FREEZE:V1");
// abi.encode(
//     address target,
//     uint256 amount,
//     uint64 expiresAt,
...
bytes32 constant PAYLOAD_KYC_V1 =
    keccak256("ERC-XXXX:PAYLOAD:KYC:V1");
// abi.encode(
//     address subject,
...
bytes32 constant PAYLOAD_FORCED_TRANSFER_V1 =
    keccak256("ERC-XXXX:PAYLOAD:FORCED_TRANSFER:V1");
// abi.encode(
//     address from,
//     address to,
//     uint256 amount,
...
Compliant logs MUST implement [ERC-165](./erc-165.md) and return `true` for
...
[ERC-8106](./erc-8106.md) defines ERC-20 value-flow observations, CE/DE entity
...
[ERC-3643](./erc-3643.md) defines regulated-token behavior, identity
...
[ERC-7943](./erc-7943.md) defines RWA token behavior including transfer
eligibility, freezing, and forced transfers. This ERC records attributed
lifecycle assertions independently of any token interface.

[ERC-7512](./erc-7512.md) defines an on-chain representation of audit reports.
