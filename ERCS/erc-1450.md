...
interface IERC1450 is IERC20, IERC165 {
     ...
     *      MUST revert if the configured fee token doesn't support [EIP-2612](./eip-2612.md)
     ...
     * @return token The [ERC-20](./eip-20.md) token used for fee payments
     ...
     * @param newFeeToken Address of the [ERC-20](./eip-20.md) token to use for fees
...
- Implementations MUST NOT return `true` from `supportsInterface(0x36372b07)` for [ERC-20](./eip-20.md)
