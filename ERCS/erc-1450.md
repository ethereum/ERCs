...
For mandatory redemptions (e.g., bond calls, forced buybacks), use [ERC-1644](https://github.com/ethereum/eips/issues/1644) controller semantics:
...
- Follow [ERC-1643](https://github.com/ethereum/eips/issues/1643) document management for notices and terms
- Provide advance notice per security agreements (typically 30-60 days)
- Maintain redemption price and payment terms on-chain or via ERC-1643
...
4. **Regulatory Notices**: Use ERC-1643 document management for required disclosures
...
2. **Document Everything**: Use ERC-1643 to store:
...
Documentation references stored via ERC-1643:
```solidity
...
2. **Document References Only**: Use ERC-1643 to store encrypted references to tax documents
