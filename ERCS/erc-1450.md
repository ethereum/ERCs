...
ERC-20 tokens do not support the regulated roles of Funding Portal, Broker Dealer, RTA, and Investor and do not support the Bank Secrecy Act/USA Patriot Act KYC and AML requirements. Other improvements (notably [EIP-1404](./eip-1404.md) (Simple Restricted Token Standard)) have tried to tackle KYC and AML regulatory requirements. This approach assigns exclusive control over `transferFrom`, `mint`, and `burnFrom` to a designated transfer agent who performs KYC and AML compliance.
...
interface IERC165 {
     ...
     * @param interfaceId The interface identifier, as specified in [ERC-165](./erc-165.md)
...
interface IERC1450 is IERC20, IERC165 {
     ...
     *      - Update corporate documents (via [ERC-1643](./erc-1643.md))
     ...
     *      Uses specific error for disabled functionality per [ERC-6093](./erc-6093.md) guidelines
     */
     ...
     *      - 0x01ffc9a7: [ERC-165](./erc-165.md) interface ID
     *      - 0xXXXXXXXX: IERC1450 interface ID (see Interface Detection section for calculation)
     *
     *      MUST return false for:
     *      - 0x36372b07: [ERC-20](./erc-20.md) interface ID
     *
     *      Returning false for [ERC-20](./erc-20.md) prevents wallets from assuming standard transfer behavior.
     *      While we are ABI-compatible with [ERC-20](./erc-20.md), we are not behaviorally compatible
     ...
     *      - If feeToken == [ERC-20](./erc-20.md) address: Fee paid via transferFrom from msg.sender
     *
     ...
     * @param to Destination address for the transfer
     * @param amount Number of tokens to transfer
     * @param feeToken Address of [ERC-20](./erc-20.md) token for fee payment (must support [EIP-2612](./eip-2612.md))
     * @param feeAmount Amount of fee being paid
     ...
     *         - [ERC-20](./erc-20.md) contract addresses for token payment
     ...
     *        - Any [ERC-20](./erc-20.md) token contract addresses
...
| Feature | [ERC-1450](./erc-1450.md) | [ERC-3643](./erc-3643.md) (T. rex) | [ERC-1400](./erc-1400.md) Suite | Standard [ERC-20](./erc-20.md) |
|---------|----------|------------------|----------------|-----------------|
...
| **Court Orders** | ✅ Native support | ⚠️ Via forced transfers | ✅ [ERC-1644](./erc-1644.md) compatible | ❌ None |
...
### Relationship to the [ERC-1400](./erc-1400.md) Security Token Suite
...
**Why Not Extend [ERC-1400](./erc-1400.md)?**
