...
For mandatory redemptions (e.g., bond calls, forced buybacks), use [ERC-1644](./eip-1644.md) controller semantics:
...
- Follow [ERC-1643](./eip-1643.md) document management for notices and terms
- Provide advance notice per security agreements (typically 30-60 days)
- Maintain redemption price and payment terms on-chain or via [ERC-1643](./eip-1643.md)
...
4. **Regulatory Notices**: Use [ERC-1643](./eip-1643.md) document management for required disclosures
...
2. **Document Everything**: Use [ERC-1643](./eip-1643.md) to store:
...
Documentation references stored via [ERC-1643](./eip-1643.md):
```solidity
...
2. **Document References Only**: Use [ERC-1643](./eip-1643.md) to store encrypted references to tax documents
...
| Feature | [ERC-1450](./erc-1450.md) | [ERC-3643](./eip-3643.md) (T. rex) | Security Token Suite | Standard [ERC-20](./eip-20.md) |
|---------|----------|------------------|----------------|-----------------|
