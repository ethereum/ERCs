...
ERC-20 tokens do not support the regulated roles of Funding Portal, Broker Dealer, RTA, and Investor and do not support the Bank Secrecy Act/USA Patriot Act KYC and AML requirements. Other improvements (notably EIP-1404 (Simple Restricted Token Standard)) have tried to tackle KYC and AML regulatory requirements. This approach assigns exclusive control over `transferFrom`, `mint`, and `burnFrom` to a designated transfer agent who performs KYC and AML compliance.
...
EIP-1404 (Simple Restricted Token Standard) provides basic transfer restrictions but does not address critical operational requirements such as recovery mechanisms, court-ordered transfers, or the designated transfer controller model.
...
| Feature | [ERC-1450](./eip-1450.md) | [ERC-3643](./eip-3643.md) (T. rex) | ERC-1400 Suite | Standard [ERC-20](./eip-20.md) |
|---------|----------|------------------|----------------|-----------------|
...
The ERC-1400 suite provides a comprehensive framework for security tokens through multiple complementary standards:
- **ERC-1594**: Core security token standard with transfer restrictions
- **ERC-1643**: Document management for off-chain documents
- **ERC-1644**: Controller operations for forced transfers
