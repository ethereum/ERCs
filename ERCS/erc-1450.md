...
interface IERC1450 is IERC20, IERC165 {
     ...
     *      Use burnFromBatch() to burn specific regulation/issuance tokens
     */
...
// Option A (FIFO): transferFromBatch(..., 100, REG_CF, March2023)
//                  transferFromBatch(..., 50, REG_D, June2023)
// Option B (LIFO): transferFromBatch(..., 50, REG_A, Sept2023)
//                  transferFromBatch(..., 100, REG_D, June2023)
...
// Using burnFromBatch(address, amount, regulation, date) - Precise control
