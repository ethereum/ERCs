...
interface IERC1450 is IERC20, IERC165 {
     ...
     *      - Update corporate documents (via [ERC-1643](./eip-1643.md))
...
| Feature | [ERC-1450](./eip-1450.md) | [ERC-3643](./eip-3643.md) (T. rex) | [ERC-1400](./eip-1400.md) Suite | Standard [ERC-20](./eip-20.md) |
|---------|----------|------------------|----------------|-----------------|
...
| **Court Orders** | ✅ Native support | ⚠️ Via forced transfers | ✅ [ERC-1644](./eip-1644.md) compatible | ❌ None |
...
### Relationship to the [ERC-1400](./eip-1400.md) Security Token Suite

The [ERC-1400](./eip-1400.md) suite provides a comprehensive framework for security tokens through multiple complementary standards:
- **[ERC-1594](./eip-1594.md)**: Core security token standard with transfer restrictions
- **[ERC-1643](./eip-1643.md)**: Document management for off-chain documents
- **[ERC-1644](./eip-1644.md)**: Controller operations for forced transfers
...
**Why Not Extend [ERC-1400](./eip-1400.md)?**
