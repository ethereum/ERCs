...
*   The contract MUST implement the [ERC-165](./eip-165.md) `supportsInterface` function and MUST return true for the `bytes4` value `0x4f3545e9` being it the `interfaceID` of the [ERC-7943](./eip-7943.md).
