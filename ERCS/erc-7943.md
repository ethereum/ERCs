...
interface IERC7943Fungible is IERC165 {
    ...
    /// @return result True if the transfer executed correctly. Reverts on failing to do so.
    ...
    /// @return result True if the freezing executed correctly. Reverts on failing to do so.
