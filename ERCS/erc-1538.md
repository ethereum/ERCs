...
Replaced by [EIP-2535 Diamond Standard](./erc-2535.md).
...
<!--
A transparent contract must implement the [ERC-165 Standard Interface Detection standard](./erc-165.md) via a delegate contract by adding the `supportsInterface` function using the `updateContract` function. The interfaceID for the ERC1538 standard is `0x61455567`.
-->
