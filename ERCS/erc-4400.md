...
Test cases are available in the reference implementation [here](../assets/erc-4400/test/erc721-consumable.ts).

## Reference Implementation

The reference implementation can be found [here](../assets/erc-4400/contracts/ERC721Consumable.sol).
