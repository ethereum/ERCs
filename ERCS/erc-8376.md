...
The suite covers every test case above across 199 tests, and adds four fuzzed invariants: a launch never pays out more than it took in, the escrow stays solvent across launches, accounted tokens never exceed the balance held, and released proceeds never exceed proceeds paid in.
