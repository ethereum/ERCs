...
**Every compliant contract must implement the `IERC7729`, and [`ERC20`](./erc-20.md) interfaces.**
...
This is the "[ERC-7729](./erc-7729.md) Metadata JSON Schema" referenced above.
