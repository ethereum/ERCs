...
It is designed as a **higher-layer execution companion** to the Regulated Agent Mandate Standard (RAMS) proposal (compliance mandates + dual `canTransact` checks) and works with both [ERC-7943](./erc-7943.md) (uRWA) and [ERC-3643](./erc-3643.md) (T-REX) tokens.
