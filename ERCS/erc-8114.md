...
Existing ERC-7564 implementations remain valid. Clients can detect permit support by checking for `IERC8114` via [ERC-165](./eip-165.md) or probing the new function selectors.
