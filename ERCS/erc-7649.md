...
Non-Fungible Tokens (NFTs) without modifying the [ERC-721](./erc-721.md) standard.
...
4.  Payment Mechanisms:
    - The embedded liquidity contract MUST support either [ERC-20](./erc-20.md) tokens or native ETH as a payment,
      it MAY support both.
