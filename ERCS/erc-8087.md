...
The goal is to support use-cases like privacy-preserving order books (preventing front-running) or conditional
delivery-versus-payment (DvP) flows,  while keeping the standard itself as generic as possible.
