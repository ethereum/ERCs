...
[ERC-4337](./erc-4337.md) defined a way to achieve Account Abstraction on Ethereum using an alternative `UserOperation` mempool.
...
* The bundler should first verify the aggregator is not throttled or banned according to [ERC-7562](./erc-7562.md) rules.
