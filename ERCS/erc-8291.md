...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| address | string (hex) | OPTIONAL | The deployed contract address ([ERC-55](https://github.com/ethereum/EIPs/blob/master/EIPS/eip-55.md) checksum format recommended). This field MUST be included if the lookup field is not used. |
