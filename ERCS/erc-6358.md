...
This ERC standardizes an interface for contract-layer consensus-agnostic verifiable cross-chain bridging, through which we can define a new global token inherited from [ERC-20](./erc-20.md)/[ERC-721](./erc-721.md) over multi-chains.  
...
- The member `signature` MUST be defined as `bytes`. It is RECOMMENDED to be created as follows.  
    ...
    - It is OPTIONAL that encapsulating the sectors in `ERC6358TransactionData` according to [EIP-712](https://github.com/ethereum/EIPs/blob/master/EIPS/eip-712.md).
    - Sign the hash value.

### Smart Contract Interface

- Every [ERC-6358](./erc-6358.md) compliant contract MUST implement the `IERC6358`  
...
The ERC-6358 Token could be implemented with the [interfaces mentioned above](#smart-contract-interface). It can also be used with the combination of [ERC-20](./erc-20.md)/[ERC-721](./erc-721.md).  

- The implementation examples of the interfaces can be found at:

    - [Interface `IERC6358`](../assets/erc-6358/src/contracts/interfaces/IERC6358.sol), the basic ERC-6358 interface mentioned [above](#smart-contract-interface)
    - [Interface `IERC6358Fungible`](../assets/erc-6358/src/contracts/interfaces/IERC6358Fungible.sol), the interface for ERC-6358 fungible token
    - [Interface `IERC6358NonFungible`](../assets/erc-6358/src/contracts/interfaces/IERC6358NonFungible.sol), the interface for ERC-6358 non-fungible token

- The implementation example of some common tools to operate ERC-6358 can be found at:

    - [Common Tools](../assets/erc-6358/src/contracts/libraries/OmniverseProtocolHelper.sol).  

- The implementation examples of ERC-6358 Fungible Token and ERC-6358 Non-Fungible Token can be found at:  

    - [ERC-6358 Fungible Token Example](../assets/erc-6358/src/contracts/ERC6358FungibleExample.sol)
    - [ERC-6358 Non-Fungible Token Example](../assets/erc-6358/src/contracts/ERC6358NonFungibleExample.sol)  
