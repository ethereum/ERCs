...
In light of account abstraction, [EIP-4337](erc-4337.md), and the advent of smart-contract wallets, we moreover specify a way to encrypt to a contract.
More precisely, we specify a way for a contract to _advertise_ how it would like encryptions to it to be constructed. This should be viewed as an analogue of [EIP-1271](erc-1271.md), but for encryption, as opposed to signing.
