...
notably through the ArkLib library. ArkLib aims to provide
...
The normative interfaces are published at `Valisthea/styx-erc-fhe-verification`:

- `contracts/interfaces/IERC8229.sol` — the core verification interface
- `contracts/interfaces/IERC8229_Chaining.sol` — verified composition of encrypted computations
- `contracts/interfaces/IERC8229_ProverRegistry.sol` — co-processor reputation, stake and slashing

A working implementation of the on-chain IVC verifier is in development and is not yet available. This section will be updated when it exists and is tested.
