...
A datum about a person is rarely a single object. It is a chain of derived artefacts, each produced
...
- **Entriken and Uribe, "Biosample permission token with non-fungible tokens" (2020)** set out the
...
7. A stable subject identifier reused across grants. The subject MUST be referenced on-chain only as
   ...
   This is a pseudonym, not anonymisation: it remains personal data while it can be linked to a
