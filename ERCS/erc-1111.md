...
description: [ERC-1111](./erc-1111.md) is a token standard that unifies [ERC-721](./erc-721.md) and [ERC-20](./erc-20.md) assets, combining ERC-20 liquidity with ERC-721 non-fungibility and enabling seamless conversion between them.
