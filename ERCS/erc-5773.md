...
/// @dev See https://ercs.ethereum.org/ERCS/erc-5773
...
2. **Why are [EIP-712](https://eips.ethereum.org/EIPS/eip-712) permit-style signatures to manage approvals not used?**\
...
The MultiAsset token standard has been made compatible with [ERC-721](./erc-721.md) in order to take advantage of the robust tooling available for implementations of ERC-721 and to ensure compatibility with existing ERC-721 infrastructure.

## Test Cases

Tests are included in [`multiasset.ts`](../assets/erc-5773/test/multiasset.ts).

To run them in terminal, you can use the following commands:

```
cd https://ercs.ethereum.org/assets/erc-5773
npm install
npx hardhat test
```
...
See [`MultiAssetToken.sol`](../assets/erc-5773/contracts/MultiAssetToken.sol).
