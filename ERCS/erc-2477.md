...
/// @dev See https://ercs.ethereum.org/ERCS/erc-2477
...
2. ERC-165 Standard Interface Detection. ./erc-165.md
3. ERC-721 Non-Fungible Token Standard. ./erc-721.md
4. ERC-1155 Multi Token Standard. ./erc-1155.md
5. JSON-LD. https://www.w3.org/TR/json-ld/
6. Secure Hash Standard (SHS). https://nvlpubs.nist.gov/nistpubs/FIPS/NIST.FIPS.180-4.pdf

Other standards

1. ERC-1046 ERC-20 Metadata Extension (DRAFT). ./erc-1046.md
2. ERC-918 Mineable Token Standard (DRAFT). ./erc-918.md
3. ERC-1523 Standard for Insurance Policies as ERC-721 Non Fungible Tokens (DRAFT). ./erc-1523.md
