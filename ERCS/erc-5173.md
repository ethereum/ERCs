...
NFTs, unlike physical art and collectibles, can accurately reflect the contributions of their owners to their value. By recording every price change of each [ERC-721](./erc-721.md) token, we can establish a Future Rewards program that fairly compensates owners. This program aims to level the playing field and provide average traders with a better chance at success.
...
![Future Rewards calculation formula](../assets/erc-5173/nFR_distribution_formula.png?raw=true)
