...
- `chainId` is the [EIP-155](https://eips.ethereum.org/EIPS/eip-155) chain identifier of the destination pool.
...
Destination pools SHOULD bind each import to an explicit user authorization, such as an [EIP-712](https://eips.ethereum.org/EIPS/eip-712) typed-data signature over the destination operation.
