...
```  
The length of strings (which functionally double as arrays) is stored in the leftmost 32 bits of the first 
slot storing the data of a given string.
