...
description: Introduces unbounded storage upgradeability from the contract level -- controlled by function invocations -- by blending extendable structs and dynamic storage spaces 
