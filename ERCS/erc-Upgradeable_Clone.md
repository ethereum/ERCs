---
erc:
title: Upgradeable Clone Standard
...
## Abstract
This ERC proposes an upgradeable proxy standard that's compatible with the factory (clone) pattern.
...
`supportsInterface(bytes4 interfaceID)` as defined in [ERC-165](./erc-165).md.
...
For instance, the Dictionary address is stored in accordance with the method defined in ***[ERC-1967: Proxy Storage Slots](./erc-1967.md)***, as follows, and other storage is arranged according to useful storage layout patterns, such as ***[ERC-7201: Namespaced Storage Layout](./erc-7201.md)***.
...
- ### Use Cases for Adopting the Upgradeable Clone Standard (UCS)
  ...
  2. When Upgradeability is not needed, but the Factory is required; ***[ERC-1167: Minimal Proxy Contract](./erc-1167.md)*** can be used.

  3. When Contract-level Upgradeability is needed, but the Factory is not required, ***[ERC-1822: Universal Upgradeable Proxy Standard (UUPS)](./erc-1822.md)*** is available.

  4. When Contract-level Upgradeability is needed, and the Factory is also required, ***[The Beacon defined in ERC-1967: Proxy Storage Slots](./erc-1967.md)*** can be utilized.

  5. When Function-level Upgradeability is needed, but the Factory is not required, ***[ERC-2535: Diamonds, Multi-Facet Proxy](./erc-2535.md)*** is available.
...
- Reference Implementations
  - [Dictionary Contract](../assets/erc-draft/src/dictionary/Dictionary.sol)
  - [Proxy Contract](../assets/erc-draft/src/proxy/ERC0000Proxy.sol)
- Tests
  - [Test suite](../assets/erc-draft/test/ERC0000Test.t.sol)
