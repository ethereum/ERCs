...
- Why [ERC-191](./erc-191.md) (Signed Data Standard) over [EIP-712](./erc-712.md) (Ethereum typed structured data hashing and signing)
    ...
    - [ERC-191](./erc-191.md) produces more human-readable messages, while [EIP-712](./erc-712.md) creates signing outputs for machine consumption, with most wallets not displaying the payload to be signed in a manner friendly to humans. **(1)**![](../assets/eip-4361/signing.png)
