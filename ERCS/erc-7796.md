...
* For all addresses with balances, validate their balance is at least the given values
* For all addresses with code, validate the code is the expected value - either empty (no code), or the expected code
