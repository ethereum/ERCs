...
description: Provides time-delayed role management, where role grants and revocations take effect after a configurable delay.
...
discussions-to: https://ethereum-magicians.org/t/erc-8305-time-delayed-access-control/28741
status: Draft
...
### Relationship with Time-Bound Access Control
...
| Dimension | Time-Bound Access Control | This ERC |
|-----------|----------|----------|
