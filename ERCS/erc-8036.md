---
eip: 8036
title: Zero-Knowledge Presentation Interface for MTC
description: Optional ERC interface for verifying ZK proofs on MTC commitments with a fixed Groth16 ABI, tied to the current anchor and active policy.
