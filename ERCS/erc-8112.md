...
Existing ERC-7204 implementations remain valid. Clients SHOULD feature-detect permit support by checking for `IERC8112` via [ERC-165](./eip-165.md) or probing the new function selectors.
