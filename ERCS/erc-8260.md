...
```solidity
keccak256("DiveData(uint32 leaveSurfaceTime,uint32 leaveBottomTime,uint32 reachSurfaceTime,uint32 bottomTimeMinutes,uint32 maxDepth,int32 averageDepth,uint8 mode,uint8 purpose,uint8 suit)")
