...
This proposal expands the metadata format for Non-Fungible Tokens ([ERC-721](./erc-721.md), [ERC-1155](./erc-1155.md), [ERC-3525](./erc-3525.md), and others), adding support for linked data like JSON-LD format. The additional data is stored under the linked_data key in the metadata JSON.
...
- [VideoObject.json](../assets/erc-7280/samples/schemas/VideoObject.json)
- [MusicRecording.json](../assets/erc-7280/samples/schemas/MusicRecording.json)
- [GoogleTravelImpactModel.json](../assets/erc-7280/samples/schemas/GoogleTravelImpactModel.json)
- [video1.json](../assets/erc-7280/samples/data/video1.json)
- [music1.json](../assets/erc-7280/samples/data/music1.json)
- [gtim1.json](../assets/erc-7280/samples/data/gtim1.json)
