...
```json
{
  ...
  "sessionProperties": {
    "permissions": "true",
    "signerTypes": "wallet,account",
    "permissionTypes": "native-token-transfer, erc20-token-transfer erc721-token-transfer, native-token-stream, erc20-token-stream native-token-periodic, erc20-token-periodic",
    "rulesTypes": "expiry"
  }
}
```
...
For a complete reference implementation of a ERC-7715 Permission handler, see the MetaMask 7715 Permissions Snap, which includes features such as:
