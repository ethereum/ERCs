...
// Native token allowance, e.g. ETH on Ethereum
// Grants the authority to transfer Native tokens bounded by a specified amount.
...
// Grants the authority to transfer ERC20 tokens bounded by a specified amount.
...
// Grants a linearly accruing Native token allowance defined by a fixed rate and start time, bounded by a maximum allowed amount.
...
// ERC20 token stream
// Grants a linearly accruing ERC20 token allowance defined by a fixed rate and start time, bounded by a maximum allowed amount.
...
// Grants the authority to transfer Native tokens periodically defined by period duration and start time, bounded by a maximum allowed amount per period.
...
// Grants the authority to transfer ERC20 tokens periodically defined by period duration and start time, bounded by a maximum allowed amount per period.
