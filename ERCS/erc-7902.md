...
[EIP-5792](https://eips.ethereum.org/EIPS/eip-5792) defines a baseline JSON-RPC API for a communication between wallets and dapps,
...
and even allow the dApp to take part in selecting the [EIP-7702](https://eips.ethereum.org/EIPS/eip-7702) account implementation.

## Motivation

[ERC-4337](./erc-4337.md) introduced Account Abstraction, enabling Smart Contract Accounts to function as first-class citizens in Ethereum.
However, while [ERC-4337](./erc-4337.md) and [ERC-7769](./erc-7769.md) define a low-level RPC API for Account Abstraction,
...
It utilises the [EIP-5792](https://eips.ethereum.org/EIPS/eip-5792) wallet capability model to express some of the critical aspects of AA,
...
Note that use of Paymasters managed by a "paymaster web service" is described in [ERC-7677](./erc-7677.md).

### Create [EIP-7702](https://eips.ethereum.org/EIPS/eip-7702) Authorization Capability

This capability is designed to be used with [EIP-7702](https://eips.ethereum.org/EIPS/eip-7702) and requests the Wallet Application to provide
...
semi-abstracted nonce as defined in [ERC-4337](./erc-4337.md).
...
Wallet Applications MUST take extreme care when working with [EIP-7702](https://eips.ethereum.org/EIPS/eip-7702).
...
For example, a Paymaster contract may hold approvals for [ERC-20](./erc-20.md) tokens which may be drained this way.
