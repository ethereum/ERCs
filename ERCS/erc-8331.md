...
1. Query the caller's roles via the role system (e.g., [EIP-8314](./eip-8314.md)'s `hasRole`)
...
+ **Role system** is replaceable: protocols may use [EIP-8314](./eip-8314.md)/[EIP-8315](./eip-8315.md) naming and semantic systems
...
| --- | --- |
| [EIP-8305](./eip-8305.md) (Delayed Role Activation) | Referenced in policy as a constraint implementation |
| [EIP-8306](./eip-8306.md) (Role-Based Timelock) | Referenced in policy as a constraint implementation |
| [EIP-8314](./eip-8314.md) (Contract Role Naming) | Role identifiers are directly compatible |
| [EIP-8315](./eip-8315.md) (Contract Role Semantics) | Role types may be used to derive groups (protocol-defined) |
