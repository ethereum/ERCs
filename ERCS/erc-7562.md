...
* **[GREP-050]** When a UserOperation is replaced (by submitting a new UserOperation, with higher gas fees), and an entity (e.g. a paymaster) is replaced, then the removed entity has its raputation (opsSeen counter) reset.
