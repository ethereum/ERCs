...
such as [ERC-4337](./erc-4337) `UserOperation` or RIP-7560 (Native Account Abstraction), which are enforced off-chain by a
...
This documentation uses the terminology "UserOperation" for a transaction created by a smart contract account, and closely follows [ERC-4337](./erc-4337) terminology.
...
* `*CALL` opcodes:
    ...
    * **[OP-062]** Precompiles:
        ...
        * The [RIP-7212](./rip-7212) sec256r1 precompile, on networks that accepted it.
