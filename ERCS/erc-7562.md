...
* **[AUTH-010]** A UserOperation may only require a single EIP-7702 authorization tuple.
* **[AUTH-020]** An EIP-7702 authorized account can only be used as the Sender of the UserOperation.
  Using authorized account as any other kind of UserOperation entity is not allowed.
* **[AUTH-030]** An EIP-7702 authorized account can only be **accessed** if it is the Sender of the current UserOperation.
