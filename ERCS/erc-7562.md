...
| `MAX_VERIFICATION_SLOTS_READ`        | 10                          | Maximum number of unique storage slots read during the validation frame                                                 |
...
* **[STO-040]** During the entire validation frame, the total number of unique storage slots being read MUST NOT exceed `MAX_VERIFICATION_SLOTS_READ`.
