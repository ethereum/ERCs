...
The implementation of `addDomain` and `removeDomain` is a trivial exercise, but candidate implementations are given here for completeness:
...
function removeDomain(
    ...
    require(domains[keccak256(abi.encodePacked(domain))] == true, "ERC7521: eTLD+1 currently not associated with this contract"); 
