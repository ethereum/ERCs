...
emits attestations that an [ERC-8004](./eip-8004.md) agent has used a skill, with three
...
`SkillAttestationHook` implements the [ERC-8183](./eip-8183.md) hook interface so that skill
...
An earlier design considered [ERC-1155](./eip-1155.md), treating skill IDs as token IDs and
