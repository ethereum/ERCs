...
The `feeRate` field MUST equal the contract's current `gaslessFeeRate` at signing time.
...
Deployed on Base mainnet since Q3 2025, > $150M gasless volume, zero incidents.
