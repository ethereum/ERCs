...
Implementations MAY include [ERC-165](./eip-165.md) interface detection support for ERC-7551.

The ERC-165 interface identifier for ERC-7551 is `0x7233a14c`.

If an implementation uses ERC-165 to signal support for other ERCs (e.g., ERC-7943), it SHOULD also indicate support for ERC-7551.
