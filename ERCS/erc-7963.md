...
### Transfer Hook
A _Permissioned ERC-20_ **MUST** consult the oracle on every value-moving
...
// canTransfer MUST revert if no valid approval exists
// ... update balances ...
...
{
  "messageId": "string",
  "creationDateTime": "RFC 3339 timestamp",
  "paymentInfo": {
    "debtor": {
      "name": "string",
      "identifier": "string",
...
- `creationDateTime`: When the instruction was created ([RFC 3339](https://www.rfc-editor.org/rfc/rfc3339) format, UTC)
...
2. **Text Normalization**: Apply UTF-8 Normalization Form C (NFC), as defined in [Unicode Standard Annex #15](https://www.unicode.org/reports/tr15/tr15-57.html), to all string fields

3. **Timestamp Format**: All timestamps **MUST** use [RFC 3339](https://www.rfc-editor.org/rfc/rfc3339) format in UTC (e.g., "2025-01-03T10:30:00Z")
...
### Upgradeability
+ Token and Oracle **MAY** be behind [ERC-1967](./eip-1967.md) proxies.
...
[Proof System Flexibility](#proof-system-flexibility) MAY be substituted.

+ **Solidity Contracts**:
  - [`PermissionedERC20.sol`](../assets/eip-7963/eip-permissioned-erc20/contracts/PermissionedERC20.sol) - ERC-20 token with oracle-based transfer validation
  - [`TransferOracle.sol`](../assets/eip-7963/eip-permissioned-erc20/contracts/TransferOracle.sol) - Manages one-time transfer approvals with ZK proof verification
  - [`ITransferOracle.sol`](../assets/eip-7963/eip-permissioned-erc20/contracts/interfaces/ITransferOracle.sol) - Oracle interface definition
  - [`RiscZeroVerifier.sol`](../assets/eip-7963/eip-permissioned-erc20/contracts/verifier/RiscZeroVerifier.sol) - RISC Zero proof verification contract

+ **ZK Guest Program**:
  - [`lib.rs`](../assets/eip-7963/eip-permissioned-erc20/zk/methods/guest/src/lib.rs) - Rust-based RISC Zero guest program for payment instruction validation and Merkle proof verification
