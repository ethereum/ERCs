...
2. **Text Normalization**: Apply UTF-8 Normalization Form C (NFC), as defined in [Unicode Standard Annex #15](https://www.unicode.org/reports/tr15/), to all string fields
