---
eip: 8203
title: Agent Conditional Settlement Interface
...
- **[ERC-8183](./eip-8183.md)** (job escrow and evaluator lifecycle): Higher layer. ERC-8183 defines business objects (jobs, submissions, evaluations); this ERC defines the lower-layer settlement envelope that such a job protocol may use for conditional payment resolution.
