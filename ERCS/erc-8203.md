...
- [ERC-7824](./eip-7824.md) (state channel framework): This ERC is designed to compose on top of a 7824-style host framework as a conditional settlement extension. It does not redefine lifecycle or custody primitives.
- [ERC-8004](./eip-8004.md) (agent identity, reputation, trust): Orthogonal. [ERC-8004](./eip-8004.md) addresses who an agent is and whether it is trusted; this ERC addresses how an agent settles conditional obligations. They may be used together.
...
- [ERC-8184](./eip-8184.md) (signed-voucher unidirectional micropayment channels): Narrower scope. [ERC-8184](./eip-8184.md) standardizes a specific payment topology (single-direction, signed-voucher) for AI service micropayments. This ERC is topology-agnostic and proof-system-agnostic; it standardizes the settlement interface, not a specific channel construction. An [ERC-8184](./eip-8184.md) channel could use this ERC's settlement extension for dispute resolution.
