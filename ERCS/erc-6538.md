...
/// [ERC-6538](https://ercs.ethereum.org/ERCS/erc-6538) to learn more.
contract ERC6538Registry {
  ...
  /// [ERC-5564](https://ercs.ethereum.org/ERCS/erc-5564) bases the format for stealth
  /// meta-addresses on [ERC-3770](https://ercs.ethereum.org/ERCS/erc-3770) and specifies them as:
...
/// in https://ercs.ethereum.org/ERCS/erc-1271[ERC-1271].
interface IERC1271 {
...
/// meta-address. See [ERC-6538](https://ercs.ethereum.org/ERCS/erc-6538) to learn more.
