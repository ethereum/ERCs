...
[EIP-1319](./erc-1319.md), from where they can be freely accessed.
...
* **See Also**: Formalized ([JSON-Schema](https://json-schema.org)) version of this specification: [package.spec.json](../assets/erc-2678/package.spec.json)
