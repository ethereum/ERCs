...
This ERC introduces no backwards compatibility issues. It is a new contract that references but does not modify existing standards ([ERC-8004](./erc-8004.md), [ERC-20](./erc-20.md), [EIP-2612](./eip-2612.md)).
