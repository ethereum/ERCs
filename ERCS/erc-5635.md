...
Anyone can retrieve licensing royalty information with `licensingRoyalty` via the registry. While it is not possible to enforce the rules set out in this EIP on-chain, just like [EIP-2981](./erc-2981.md), we encourages NFT marketplaces to follow this EIP.
...
This standard is compatible with [EIP-721](./erc-721.md), [EIP-1155](./erc-1155.md), and [EIP-2981](./erc-2981.md).

## Reference Implementation

### Examples

#### Deploying an [EIP-721](./erc-721.md) NFT and signaling support for dNFT
