...
This standard is an extension of [EIP-20](./erc-20.md). This specification defines a type of escrow service with the following flow:
...
- *Payable Contract*: The sellers and buyers use this token to fund the *Escrow Contract*. This contract MUST override [EIP-20](./erc-20.md) interfaces.
- *Escrow Contract*: Defines the escrow policies and holds *Payable Contract*'s token for a certain period. This contract does not requires override [EIP-20](./erc-20.md) interfaces.
...
The *Payable Contract* which implements this EIP is fully backward compatible with the [EIP-20](./erc-20.md) specification.

## Test Cases

[Unit test example by truffle](../assets/erc-5528/truffule-test.js).
