...
This standard is an extension of [ERC-721](./erc-721.md). It proposes adding a `nonce` function to ERC-721 tokens.
...
Test cases are included in [test.js](../assets/erc-5008/test/test.ts).

Run:

```sh
cd https://ercs.ethereum.org/assets/erc-5008
npm install
npm run test
```
...
See [`ERC5008.sol`](../assets/erc-5008/contracts/ERC5008.sol).
