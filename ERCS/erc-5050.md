...
A reference implementation is included in `../assets/erc-5050` with a simple stateless example [`ExampleToken2Token.sol`](../assets/erc-5050/ExampleToken2Token.sol), and a stateful example [`ExampleStateContract.sol`](../assets/erc-5050/ExampleStateContract.sol)
