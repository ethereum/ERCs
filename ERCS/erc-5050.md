...
They can be implemented using a modified version of [EIP-1820](./eip-1820.md#erc-1820-registry-smart-contract) that allows [EIP-173](./erc-173.md) contract owners to call `setManager()`.
...
A reference implementation is included in `../assets/eip-5050` with a simple stateless example [`ExampleToken2Token.sol`](../assets/erc-5050/ExampleToken2Token.sol), and a stateful example [`ExampleStateContract.sol`](../assets/erc-5050/ExampleStateContract.sol)
