...
Accounts MUST implement the above `accountId()` & `accountStorageBases()` to be compliant with the ERC-7779.
...
![diagram.png](../assets/erc-7779/diagram.png)
...
[ERC-7779](./erc-7779.md) provides a standard approach for fetching the storage base used in the delegated account together with an optional mechanism to clean up the storage.
