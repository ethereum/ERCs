...
It does **not** prescribe how transfers are executed; that is defined by a separate EIP ("Permissioned Pull", [ERC-8102](./eip-8102)).
...
- the **authorization object** ([ERC-8103](./eip-8103), this EIP), and
