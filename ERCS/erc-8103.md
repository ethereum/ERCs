...
This EIP defines a **Permissioned Authorization Object (PPO)**: an [EIP-712](https://eips.ethereum.org/EIPS/eip-712) typed struct describing a *bounded, revocable permission to pull tokens* from a grantor.
...
Today, [ERC-20](https://eips.ethereum.org/EIPS/eip-20) and related standards lack a canonical primitive for *fine-grained pull permissions*.
...
- `permit` ([EIP-2612](https://eips.ethereum.org/EIPS/eip-2612)) — signed approvals, but tightly coupled to token contracts
