...
- the **authorization object** (defined herein), and
...
- enforce [EIP-2](./eip-2.md) signature constraints (low-`s`, valid `v`),
- bind verification to their own domain separator.

## Rationale

- **Separation of concerns**: This proposal defines “what is consent?” while ERC-8102 defines “how is consent executed?”. This keeps wallets, AA stacks, and registries decoupled from any specific executor implementation.
