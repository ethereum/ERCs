...
/**
    ...
    @dev See https://ercs.ethereum.org/ERCS/erc-6617
*/
interface IEIP6617 {
...
Currently permission and access control is performed using a single owner ([ERC-173](./erc-173.md)) or with `bytes32` roles ([ERC-5982](./erc-5982.md)).
...
- [Basic ERC-6617 implementation](../assets/erc-6617/contracts/EIP6617.sol)
