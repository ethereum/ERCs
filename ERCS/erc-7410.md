...
This extension adds a decrease allowance mechanism to [ERC-20](./erc-20.md) allowances, in which a spender can revoke or decrease a given allowance by a specific address. This ERC extends [ERC-20](./erc-20.md).
...
By having a way to approve and revoke in a manner similar to [ERC-20](./erc-20.md), the trust level can be more directly managed by spender:
