...
discussions-to: https://ethereum-magicians.org/t/erc-8313-protocol-interaction-manifest/28663
status: Draft
...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| address | string (hex) | OPTIONAL | The deployed contract address. This field MUST be included if the lookup field is not used. |
