...
The IRNFTRoyalty interface defines the royalty distribution for rNFTs and MUST inherit `IERC165` so that supporting contracts can advertise compliance via [ERC-165](./eip-165.md):
