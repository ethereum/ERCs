...
- **EntryPoint** - A trusted singleton contract according to [ERC-4337](./erc-4337.md) specifications.
...
A full interface of a smart account can be found in [`IMSA.sol`](../assets/erc-7579/IMSA.sol).
