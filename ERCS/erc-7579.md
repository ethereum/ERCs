...
To comply with this standard, smart accounts MUST implement the execution interface (except for the optional function) below:
...
- execType (1 byte): `0x00` for a normal execution, `0x01` for a try/catch execution
...
interface IAccountConfig {
    ...
    /**
     * @dev Function to check if the account supports a certain CallType or ExecType
    ...
    /**
     * @dev Function to check if the account supports installation of a certain module typeId
