...
contract MessagingSystem {
    ...
    // Function to update a user's public key
    function updateUserPublicKey(bytes memory _newPublicKey, PublicKeyAlgorithm _algorithm) public {
        users[msg.sender].publicKey = _newPublicKey;
        users[msg.sender].algorithm = _algorithm;
        emit PublicKeyUpdated(msg.sender, _newPublicKey, _algorithm);
    }
