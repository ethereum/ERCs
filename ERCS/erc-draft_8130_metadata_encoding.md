...
description: A structured CBOR encoding for the EIP-8130 metadata field covering attribution, memos, and commitments to offchain data scoped to a transaction, phase, or call, with an offchain selective-disclosure and delivery protocol
