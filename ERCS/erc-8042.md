...
## Abstract
This standard formalizes the diamond storage pattern originally introduced by [ERC-2535](./eip-2535.md) and widely adopted across smart contracts.
...
ERC-8042 Diamond Storage depends conceptually on ERC-2535 Diamonds, which first introduced the pattern of distinct storage areas for modular contracts. ERC-7201 later standardized the idea. ERC-8042 standardizes the original, simpler diamond storage variant for new projects and legacy compatibility.
