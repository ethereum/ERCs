...
## Abstract
This standard formalizes the diamond storage pattern originally introduced by [ERC-2535 Diamonds](./erc-2535.md) and widely adopted across smart contracts.
...
[ERC-8042](./erc-8042.md) standardizes this simple and production-proven approach, offering a lightweight alternative to [ERC-7201](./erc-7201.md) for new and existing projects.
