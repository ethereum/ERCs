...
Building on the namespaced storage identifier mechanism defined in [ERC-8042 (Diamond Storage)](./erc-8042.md), this proposal organizes contract state into domains and sub-domains.  
...
[ERC-2535 (Diamond Standard)](./erc-2535.md) provides a flexible foundation for modular smart contracts through facets, but it intentionally leaves storage organization and architectural conventions open to implementation.  
