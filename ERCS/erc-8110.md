...
[ERC-8109 (Diamond, Simplified)](./eip-8109.md), together with the storage identifier mechanism defined by [ERC-8042 (Diamond Storage Identifier)](./eip-8042.md).
...
- These helpers can also be reused across different versions, making data access logic consistent and predictable.

- When new variables are added, corresponding helpers can be introduced, reducing the risk of human error at the facet level.
