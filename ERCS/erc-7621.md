...
eip: 7621
title: Basket Token
description: The Basket Token Standard (BTS) enables the creation of tokenized funds with predefined weights, backed by on-chain liquidity, allowing for diversified investment portfolios. The BTSPair contract manages liquidity within a BTS, adjusting reserves and creating or destroying BTS LP tokens based on user actions.
