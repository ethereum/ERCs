...
Every contract compliant with this ERC MUST implement the ITimeBoundAccessControl interface. Contracts SHOULD also implement [ERC-165](./erc-165.md) to support interface detection.
