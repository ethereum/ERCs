...
```json
{
  ...
  "files": [
    {
      "file_name": "example_file1.txt",
      "sha256": "0xabcdef1234567890"
    },
    {
      "file_name": "example_file2.jpg",
      "sha256": "0x1234567890abcdef"
    }
  ]
}
```
...
See [`server.js`](../assets/eip-7628/server.js) for `download_uri` Implementation.
