...
Some NFTs, like ownership stakes in companies, require token holders to have a share of corresponding rights. However, [ERC-721](./eip-721.md) lacks built-in support for token balances, hindering efficient management and trading. Introducing balance functionalities similar to [ERC-20](./eip-20.md) would offer a universal solution, enabling easy querying and trading of these rights, thereby enhancing NFT adoption and circulation.
