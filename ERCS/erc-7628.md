...
We removed the `transfer` function from [ERC-20](./eip-20.md) because when transferring, we must use the tokenId. If we add it back, it will duplicate the functionality of `transferFrom`.
