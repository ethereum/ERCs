...
- When a checksum is provided, clients MAY validate it by deriving the underlying _Interoperable Address_ and recalculating the checksum.
...
This specification does not define its own versioning mechanism. Since _Interoperable Names_ are designed to be converted into [ERC-7930] Interoperable Addresses, the versioning is inherited from [ERC-7930].
