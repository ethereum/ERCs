...
- The ENS protocol is a well-established blockchain identity primitive that allows the registration of names like `example.eth` that _resolve_ to addresses on a chain-specific basis. It is familiar and well understood.
