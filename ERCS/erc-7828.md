...
[^1]: While this sees production usage, it is not consistent with the design principles behnd [ERC-7930] and assumes 32-bit chainids, which are not compatible with an [ERC-7785] future. We recommend using something closer to what is described in footnote 2.
