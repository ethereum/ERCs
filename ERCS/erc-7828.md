...
- For addresses on chains that are both supported by [SLIP44] and the special scheme for the `eip155` namespace defined in ENSIP-11, the latter should be used.
