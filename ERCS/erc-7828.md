...
The checksum provides an optional integrity verification mechanism for _Interoperable Names_.

- The checksum is OPTIONAL but RECOMMENDED, as it helps mitigate homoglyph and spoofing attacks.
...
- When a checksum is provided, clients SHOULD validate it by deriving the underlying _Interoperable Address_ and recalculating the checksum.
...
Since _Interoperable Names_ are designed to be converted into [ERC-7930] _Interoperable Addresses_, implementers SHOULD ensure they are up to date with the version of [ERC-7930] they are using. Refer to the versioning section of [ERC-7930] for detailed rules.
