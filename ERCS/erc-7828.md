...
Forward resolution (Interoperable Address -> Interoperable Name): Supported via the multichain address resolution standard defined in [ERC-2304](./erc-2304.md), which uses coin types from [SLIP44] to resolve names for various chains, including the [EIP-155](./eip-155.md) namespace.
