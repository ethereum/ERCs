...
5. Look up the output of step 3 in the name registry registry. It instructs to use the hard-coded shortcode list, with TLD `.short`
...
8. Look up the output of step 4 in the name registry registry. It instructs to use ENS.
