...
description: A method for contracts to support inheritance of tokens after the owner's death
...
This EIP is compatible with existing token standards like [ERC-20](./erc-20.md), [ERC-721](./erc-721.md) and [ERC-1155](./erc-1155.md). It can be implemented alongside these standards without affecting their core functionality.
