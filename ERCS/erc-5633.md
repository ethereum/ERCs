...
This standard outline a interface to EIP-1155 that allows wallet implementers and developers to check for soulbound property of token ID using [EIP-165](./erc-165.md). the soulbound property can be checked in advance, and the transfer function can be called only when the token is not soulbound.
...
Test cases are included in [test.js](../assets/erc-5633/test/test.js). 

Run in terminal:

```shell
cd https://ercs.ethereum.org/assets/erc-5633
npm install
npx hardhat test
```

Test contract are included in [`ERC5633Demo.sol`](../assets/erc-5633/contracts/ERC5633Demo.sol). 

## Reference Implementation

See [`ERC5633.sol`](../assets/erc-5633/contracts/ERC5633.sol).
