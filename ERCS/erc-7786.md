...
A **Destination Gateway** is a contract that implements a protocol to validate messages sent on other chains. The interface optionally specifies how an application can read message from the gateway.
