...
over the registry — for example that the EIP-1967 implementation and admin slots
are empty and that the deployed source exposes no owner, admin, initializer, or
proxy — rather than inferring immutability from vector conformance alone.
