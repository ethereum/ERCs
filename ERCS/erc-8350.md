...
author: Everest An (@everest-an), XiaoHai (@XiaoHai67890), Luo (@lucas1968), Eric
...
[the machine-readable test vector](../assets/eip-8350/test-vectors-v1.json).

## Reference Implementation

The reference implementation contains a Solidity registry
([`AgentMemoryStateRegistry.sol`](../assets/eip-8350/AgentMemoryStateRegistry.sol),
implementing [`IAgentMemoryState.sol`](../assets/eip-8350/IAgentMemoryState.sol)),
...
Verifiers assessing a deployment SHOULD confirm that no upgrade authority exists
over the registry — for example that the [ERC-1967](./eip-1967.md) implementation
and admin slots are empty and that the deployed source exposes no owner, admin,
initializer, or proxy — rather than inferring immutability from vector conformance
alone.
