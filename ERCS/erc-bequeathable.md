...
---
title: EIP-draft - Bequeathable Contracts  
description: A standard interface for contracts to support inheritance of tokens after the owner's death  
...
category: ERC  
created:  2025-02-01  
requires: ERC-165, ERC-20, ERC-721, ERC-1155  
---
...
Tests are included in [`bequeath.test.js`](https://eips.ethereum.org/assets/eip-bequeathable/test/bequeath.test.js).

To run them in the terminal, you can use the following commands:
...
Or alternatively run the make command:
...
See [`Bequeathable.sol`](https://eips.ethereum.org/assets/eip-bequeathable/contracts/Bequeathable.sol)
