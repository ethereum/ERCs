...
discussions-to: https://ethereum-magicians.org/t/draft-privacy-address-format/26689
status: Draft
...
The format is designed to work with [ERC-8086](https://ethereum-magicians.org/t/erc-8086-privacy-token/26623) (Privacy Token), [ERC-8085](https://ethereum-magicians.org/t/erc-8085-dual-mode-fungible-tokens/26592) (Dual-Mode Fungible Tokens), and any wrapper protocol built on ERC-8086 that adds privacy capabilities to existing [ERC-20](./eip-20) tokens.
...
- **Wrapper protocol compatible**: Applicable to any wrapper protocol built on [ERC-8086](https://ethereum-magicians.org/t/erc-8086-privacy-token/26623) that adds privacy capabilities to existing [ERC-20](./eip-20) tokens (e.g., DAI → zDAI)
...
[ERC-8086](https://ethereum-magicians.org/t/erc-8086-privacy-token/26623) defines the interface for native privacy tokens (IZRC20), and [ERC-8085](https://ethereum-magicians.org/t/erc-8085-dual-mode-fungible-tokens/26592) enables dual-mode tokens with both public and private capabilities. However, these standards leave the **address format** unspecified.
...
For protocols using zero-knowledge proofs (such as [ERC-8086](https://ethereum-magicians.org/t/erc-8086-privacy-token/26623) and [ERC-8085](https://ethereum-magicians.org/t/erc-8085-dual-mode-fungible-tokens/26592)), pv1 uses the Baby Jubjub curve which provides better performance in zk-SNARK circuits due to its native compatibility with the BN254 scalar field.
...
| Ethereum Testnet | `T` | 5/11155111 | Testing networks   |
...
- **[ERC-8086](https://ethereum-magicians.org/t/erc-8086-privacy-token/26623)/[ERC-8085](https://ethereum-magicians.org/t/erc-8085-dual-mode-fungible-tokens/26592)**: Fully compatible; pv1 provides the address format these standards need for client-side operations
- **[ERC-5564](./eip-5564)**: Complementary; pv1 uses different curve for zk-SNARK optimization
- **[ERC-20](./eip-20)**: Independent; pv1 addresses are for privacy mode only
- **Existing wallets**: Can add pv1 support without blockchain upgrades
