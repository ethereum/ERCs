...
The format is designed to work with [ERC-8086](./eip-8086) (Privacy Token), [ERC-8085](./eip-8085) (Dual-Mode Fungible Tokens), and any wrapper protocol built on ERC-8086 that adds privacy capabilities to existing [ERC-20](./eip-20) tokens.
...
- **Wrapper protocol compatible**: Applicable to any wrapper protocol built on [ERC-8086](./eip-8086) that adds privacy capabilities to existing [ERC-20](./eip-20) tokens (e.g., DAI → zDAI)
...
[ERC-8086](./eip-8086) defines the interface for native privacy tokens (IZRC20), and [ERC-8085](./eip-8085) enables dual-mode tokens with both public and private capabilities. However, these standards leave the **address format** unspecified.
...
For protocols using zero-knowledge proofs (such as [ERC-8086](./eip-8086) and [ERC-8085](./eip-8085)), pv1 uses the Baby Jubjub curve which provides better performance in zk-SNARK circuits due to its native compatibility with the BN254 scalar field.
...
- **[ERC-8086](./eip-8086)/[ERC-8085](./eip-8085)**: Fully compatible; pv1 provides the address format these standards need for client-side operations
...
- [ERC-8086](./eip-8086): Privacy Token (IZRC20) - The base interface for privacy tokens that pv1 addresses work with
- [ERC-8085](./eip-8085): Dual-Mode Fungible Tokens - Tokens with both public and private modes using pv1 addresses
- [ERC-5564](./eip-5564): Stealth Addresses - General stealth address standard using secp256k1; pv1 provides zk-SNARK optimized alternative
