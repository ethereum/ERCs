...
[EIP-4337](./erc-4337.md) also implements gas payment delegation. BCE and [EIP-4337](./erc-4337.md) are not mutually exclusive and can be implemented concurrently within an SCA.
