...
### JSON-RPC API for [ERC-4337](./eip-4337.md)
...
One common approach to this problem is often referred to as "diamond storage" and is fully described in [ERC-7201](./eip-7201.md).

### Transient Storage

Contracts using the [EIP-1153](./eip-1153.md) transient storage MUST take into account that ERC-4337 allows multiple
