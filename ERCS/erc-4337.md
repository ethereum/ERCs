...
* **Try to support other use cases**
    ...
    * Pay tx fees with [ERC-20](./eip-20.md) tokens, allow developers to pay fees for their users, and [EIP-3074](https://github.com/ethereum/EIPs/blob/master/EIPS/eip-3074.md)-like **sponsored transaction** use cases more generally
...
**Parameters**: same as `eth_sendUserOperation`
  ...
  `maxFeePerGas` and `maxPriorityFeePerGas` default to zero, so no payment is required by either account or paymaster.
