...
There is no way for the `EntryPoint` contract to know whether the EIP-7702 account has been initialized or not.
The `initEip7702Sender()` function, and therefor the EIP-7702 account initialization code, can be called multiple times.
