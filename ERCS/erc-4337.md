...
Users send `UserOperation` objects to a dedicated user operation mempool.
...
All of these checks do not rely on EVM state, and cannot be changed by other transaction.
