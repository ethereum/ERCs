...
Maliciously crafted paymasters could be ableto perform a DoS attack against the system.
To prevent this, bundlers should use a reputation system for contracts they serve, and the paymaster must either limit its storage usage, or deposit a stake in a reputation system.
