...
If this parameter is set, it should be a valid [EIP-7702] tuple, and signed by the sender address.
The bundler should add all the eip7702auth of all UserOps it to the authorizationList of the bundle transaction.
