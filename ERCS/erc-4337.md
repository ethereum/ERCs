...
* **Try to support other use cases**
    ...
    * Atomic multi-operations (similar goal to [EIP-3074](https://eips.ethereum.org/EIPS/eip-3074))
    * Pay tx fees with [ERC-20](./erc-20.md) tokens, allow developers to pay fees for their users, and [EIP-3074](https://eips.ethereum.org/EIPS/eip-3074)-like **sponsored transaction** use cases more generally
...
Transient Storage slots defined in [EIP-1153](https://eips.ethereum.org/EIPS/eip-1153) and accessed using `TLOAD` (`0x5c`) and `TSTORE` (`0x5d`) opcodes
