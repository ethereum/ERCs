...
| `factory`                       | `address` | account factory for new accounts OR `0x7702` flag for EIP-7702 accounts        |
| `factoryData`                   | `bytes`   | data for account factory if `factory` exists OR EIP-7702 initialization data   |
