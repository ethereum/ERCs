...
In order to termine the time-range returned by the validateUserOp and validatePaymasterUserOp, the bundler should perform the simulation using debug_traceCall (which is also required for the full validation, as described in [ERC-7562](./eip-7562.md)
