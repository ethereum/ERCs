...
* The calldata gas cost related to the `UserOperation` (defined in [EIP-2028](./eip-2028.md))
...
* [EIP-7623](./eip-7623.md) calldata increase: when calculating `execution_gas_used` of this UserOperation, 
   for the purpose of checking the "floor price", the bundler should use the known gas: verification (account creation, validation and paymaster validation) and 10% of the execution gas limit (since actual execution gas can't be determined during validation)
