...
* Cost of performing the memory expansion when loading the `UserOperation` into EVM memory.
  This includes the call to the `innerHandleOp()` function which is a major part of the `EntryPoint` implementation.
