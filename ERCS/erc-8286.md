...
This standard therefore defines no new execution interface: ERC-7579 already covers contract-dispatched `DEFAULT` frmae execution, and no interface can cover `SENDER` frames.
