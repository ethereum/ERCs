...
category: ERC
created: 2025-12-21
withdrawal-reason: Superseded by EIP-8153
---
...
Diamond contracts were originally standardized by [ERC-2535](./erc-2535.md). This standard refines that specification by simplifying terminology, reducing the implementation complexity of introspection functions, and standardizing specific events.
...
Additional motivation and background for diamond-based smart-contract systems can be found in [ERC-1538](./erc-1538.md) and [ERC-2535](./erc-2535.md).
...
ERC-2535 standardized introspection functions and events. [ERC-8109](./erc-8109.md) re-standardizes these to make diamond contracts easier to implement and easier to understand.
...
1. **Optional, gas-optimized functionality**  
   ...
   For example, an [ERC-721](./erc-721.md) diamond may implement batch transfer functions in a dedicated facet, improving both gas efficiency and usability while keeping the base ERC-721 implementation simple and well-scoped.
...
Diamonds and facets need to use a storage layout organizational pattern because Solidity’s default storage layout doesn’t support proxy contracts or diamonds. The storage layout technique or pattern to use is not specified in this ERC. However, examples of storage layout patterns that work with diamonds are [ERC-8042 Diamond Storage](./erc-8042.md) and [ERC-7201 Namespaced Storage Layout](./erc-7201.md).
