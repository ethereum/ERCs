...
A diamond compliant with [ERC-8109](./eip-8109.md) is NOT required to implement [ERC-2535](./eip-2535.md).

Here are changes in [ERC-8109](./eip-8109.md) Diamonds:
...
[ERC-8109](./eip-8109.md) implementations are free to add iteration or pagination-based introspection functions, but they are not required by this standard.
