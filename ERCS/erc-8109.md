...
<img src="../assets/erc-8109/diamond.svg" width="17%" align="right">Through a single address, a diamond provides functionality from multiple implementation contracts (facets). Each facet is independent, yet facets can share internal functions and storage. This architecture allows arbitrarily large smart-contract systems to be composed and presented as a single contract, simplifying deployment, testing, and integration with other contracts, off-chain software, and user interfaces.
