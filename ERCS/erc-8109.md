...
The new and optional `DiamondMetadata(bytes32 indexed _tag, bytes _data)` event provides a standard way to record versioning and other information about diamonds.
