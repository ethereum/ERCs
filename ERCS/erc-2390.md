...
resolvers storing DNS resource records [EIP-1185](./erc-1185.md), although the technique could be
used on other interfaces like IPFS content hash storage [EIP-1062](./erc-1062.md).
...
ENS can respond to queries with IP addresses (as described in [EIP-1185](./erc-1185.md))
...
In addition to geographic split horizon DNS, GeoENS can be used for the following:
 ...
 - ENS + IPFS web hosting (as described in [EIP-1062](./erc-1062.md)) with content translated to the native language of the query source.
