...
In the [../assets/erc-7746/ILayers.sol](../assets/erc-7746/ILayers.sol) a reference interface is provided.

In this test, a [Protected.sol](../assets/erc-7746/test/Protected.sol) contract is protected by a [RateLimitLayer.sol](../assets/erc-7746/test/RateLimitLayer.sol) layer. The RateLimitLayer implements the ILayer interface and enforces a rate which client has configured.
