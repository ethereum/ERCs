...
description: Optional ERC-20 extension to pre-allocate a balance slot via a sentinel bytes32 value, shifting the first 20k-gas SSTORE earlier to reduce later transfer costs.
