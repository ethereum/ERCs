---
eip: 8003
title: [ERC-20](../EIPS/eip-20.md) Pre-initialization (Sentinel Storage)
...
**ERC-721A takes a "low gas now, higher gas later" approach:**
...
A minimal example contract is provided in the repository (see the `contracts/` folder under `ariutokintumi/ERC-20-Pre-initialization`). Don't use for production until a security audit is performed.
