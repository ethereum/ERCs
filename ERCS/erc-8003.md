...
A minimal example contract is provided in the repository (file contracts/ERC20PreinitExample.sol under the repository ariutokintumi/ERC-20-Pre-initialization). Don't use for production until a security audit is performed.
