# ERC-XXXX Trustless Agents v0.4
...
The `agentAddress` field follows the [CAIP-10](https://chainagnostic.org/CAIPs/caip-10) account identifier standard: `{namespace}:{reference}:{address}`.
