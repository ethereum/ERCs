...
The library [`Types.sol`](../assets/erc-7509/Types.sol) contains an enumeration of Solidity types used in the above interfaces.
...
See [Ethereum ECS Example](../assets/erc-7509/README.md)
