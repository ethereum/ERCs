...
Account abstraction (AA) is a direction of the smart contract wallet, which works around abstract accounts. This ERC can also be an extension based on [ERC-4337](./erc-4337.md) or as a plug-in for wallets.
...
The smart contract wallet interface of this ERC is for asset management and asset approval. It supports the simpletoken <!-- TODO --> ERC-X, and [ERC-20](./erc-20.md) is backward compatible with <!-- TODO --> ERC-X, so it can be compatible with the management of all fungible tokens in the existing market.
...
** Compliant contract must implement the [ERC-165](./erc-165.md) interfaces**

```solidity
/// @title ERC-7204 
/// @dev See https://ercs.ethereum.org/ERCS/erc-7204
