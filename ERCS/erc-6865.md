...
![](../assets/erc-6865/current-EIP-712-signature-wallet-interface.png)
...
![](../assets/erc-6865/vision-EIP-712-signature-wallet-interface.png)
...
- `assetTokenAddress` is the token ([ERC-20](./erc-20.md), [ERC-721](./erc-721.md), [ERC-1155](./erc-1155.md)) smart contract address where the zero address MUST represents the Native coin (Native ETH in the case of Ethereum network).
...
openSea Seaport NFT marketplace implementation example is available [here](../assets/erc-6865/contracts/SeaPortEIP712Visualizer.sol)
