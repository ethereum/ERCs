...
description: A function set for contracts holding funds to release them only against a zero-knowledge proof that the payment satisfies a registered policy
