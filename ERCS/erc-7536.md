...
This standard gives the interfaces for implementing such a tiered system. It empowers any ERC-721 tokens with the ability to create editions of child tokens that give privileges at a cost.
