...
The reference implementation in the repository includes a full test suite covering registration, staking, slashing, and graduation scenarios. See `test/AgentRegistry.t.sol` and `test/AgentStaking.t.sol`.
...
### Accountability anchor limitations
