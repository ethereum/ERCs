...
❗️ **[ERC-7409](./erc-7409.md) supersedes [ERC-6381](./erc-6381.md).** ❗️

The Public Non-Fungible Tokens Emote Repository standard provides an enhanced interactive utility for [ERC-721](./erc-721.md) and [ERC-1155](./erc-1155.md) by allowing NFTs to be emoted at.
...
This ERC introduces new utilities for [ERC-721](./erc-721.md) based tokens in the following areas:

- [Interactivity](#interactivity)
- [Feedback based evolution](#feedback-based-evolution)
- [Valuation](#valuation)

This proposal fixes the compatibility issue in the [ERC-6381](./erc-6381.md) interface specification, where emojis are represented using `bytes4` values. The introduction of variation flags and emoji skin tones has rendered the `bytes4` namespace insufficient for representing all possible emojis, so the new standard used `string` instead. Apart from this fix, this proposal is functionally equivalent to [ERC-6381](./erc-6381.md).
...
/// @dev See https://ercs.ethereum.org/ERCS/erc-7409
...
This is how this proposal fixes the forward compatibility issue of the [ERC-6381](./erc-6381.md).

## Backwards Compatibility

The Emote repository standard is fully compatible with [ERC-721](./erc-721.md) and with the robust tooling available for implementations of ERC-721 as well as with the existing ERC-721 infrastructure.

## Test Cases

Tests are included in [`emotableRepository.ts`](../assets/erc-7409/test/emotableRepository.ts).

To run them in terminal, you can use the following commands:

```
cd https://ercs.ethereum.org/assets/erc-7409
npm install
npx hardhat test
```
...
See [`EmotableRepository.sol`](../assets/erc-7409/contracts/EmotableRepository.sol).
