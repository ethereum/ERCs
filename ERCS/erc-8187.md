...
A reference implementation is provided, with a commented interface and an _educational example_ implementation of a Puller that pulls funds deinvesting from a vault.

**This example has not been audited and should not be used in production environments.**

See [contracts](../assets/erc-8187/README.md)
