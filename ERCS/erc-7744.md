...
Reference implementation of the Code Index can be found in the assets folder. There you can find the [interface](../assets/erc-7744/IERC7744.sol) and the [implementation](../assets/erc-7744/ERC7744.sol) of the Code Index.
