...
The `CodeIndex` contract is deployed at: `0xC0de1D738816ef987Fa48800E10eC89D07d1E2b7` using `CREATE2` via the deterministic deployer at `0x4e59b44847b379578588920ca78fbf26c0b4956c` with a salt of `0xa949692e705813892bc02a55c945bb997f13a27dc2b4844b9e1280b82273f528` is obtained by seeking a vanity address with meaningful name "Code ID (`0xC0de1D`) for a bytecode compiled with `solc 0.8.28` as `solc --input-file src/ERC7744.sol --bin --optimize --optimize-runs 2000 --metadata-hash none --via-ir --optimize-yul`
