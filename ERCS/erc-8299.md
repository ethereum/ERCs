...
- [VeriLLM](https://arxiv.org/abs/2509.24257) — Ke Wang et al. (Gradient, 2025). Publicly verifiable decentralized LLM inference via Merkle-committed hidden states and VRF-based recompute. Compute-integrity complement to ERC-8299's behavioral-integrity layer.
