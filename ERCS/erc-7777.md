---
eip: 7777
title: Standardized Smart Account Interfaces
description: A standardized way for apps, wallets, and smart account tooling to interact with Smart Accounts
author: Derek Chiang (TBD), Fil Makarov (TBD), Kristof Gazso(TBD), Derek Rein (@arein), Juan Caballero (TBD), Tomas Rocchi (TBD), Jake Moxey (@jxom)
...
The counterfactual call contract is inspired by ERC-6492, which devised a mechanism to execute `isValidSignature` (ERC-1271) against a pre-deployed (counterfactual) contract.
