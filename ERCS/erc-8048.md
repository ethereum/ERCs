...
For the full specification of metadata hooks, see [ERC-8121](./8121.md) (Metadata Hooks). The hook function signature `ContractMetadataHook(string,address)` with selector `0xcae9bb7e` is defined for use with this ERC.
