...
This EIP proposes a new interface that allows [ERC-721](./erc-721.md) token owners to grant limited usage of those tokens to other addresses.
...
This extension uses [ERC-1046](./erc-1046.md) for `tokenURI` compatibility.
...
[ERC-20](./erc-20.md) and [ERC-1155](./erc-1155.md) are unsupported as partial ownership is much more complex to track than boolean ownership.
...
The security considerations of [ERC-721](./erc-721.md) and [ERC-1046](./erc-1046.md) apply.
