...
Standard functions as a token contract and also contracts working with tokens can implement the standard to make a token Payable.
...
Anyways, you can use it for specific utilities or for any other purposes that require the execution of a callback after a transfer or approval received.
