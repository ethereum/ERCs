...
[ERC-8004](./erc-8004.md) provides an open mint registry where anyone can register agent identities without restrictions. While this unlimited minting model serves many use cases, there is a clear need for limited-supply collections of agents. ERC-8041 addresses this by defining a standard interface for creating fixed-supply collections that leverage the existing [ERC-8004](./erc-8004.md) registry infrastructure while adding collection-specific constraints, metadata, and provenance tracking through mint numbers.

## Backwards Compatibility

This standard is fully backwards compatible with:

- **[ERC-721](./erc-721.md)**: Agents remain standard ERC-721 tokens
