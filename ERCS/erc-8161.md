...
This standard extends [ERC-7540](./erc-7540.md) by adding optional transferability of pending deposit and redeem Requests. It introduces two separate interfaces that allow a controller to transfer their pending Request balance to a new controller. Implementations may support either or both interfaces independently.

## Motivation

[ERC-7540](./erc-7540.md) asynchronous Requests can remain in the Pending state for an extended period of time. During this period, controllers have no way to transfer their position to another address. This creates friction for users who need to migrate wallets, restructure positions across accounts, or integrate with protocols that compose on top of pending Request positions.
...
This standard is fully backward compatible with [ERC-7540](./erc-7540.md). Vaults that do not implement this extension continue to function as before. Integrators can detect support for transferability via [ERC-165](./erc-165.md) `supportsInterface`.
