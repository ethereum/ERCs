...
This standard is an extension of [ERC-20](./erc-20.md). It defines new validation functionality to avoid wallet draining: every `transfer` or `approve` will be locked waiting for validation.
...
[ERC-20](./erc-20.md) compliant contracts MAY implement this EIP.
...
This standard is an extension of [ERC-20](./erc-20.md), compatible with all the operations except `transfer`/`transferFrom`/`approve`.
