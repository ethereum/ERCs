...
The `mirrorERC721` and `baseERC20` methods returning non-zero addresses signal that the [ERC-20](./eip-20.md) and [ERC-721](./eip-721.md) contracts implement the required ERC-7631 interfaces respectively. As such, [ERC-165](./eip-165.md) is not required.
