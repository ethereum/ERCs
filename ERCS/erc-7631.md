...
category: ERC
created: 2024-02-21
requires: [EIP-20](./eip-20.md), [EIP-721](./eip-721.md)
---
...
For dual nature collections that offer ERC-721 tokens with differing rarity levels, the ERC-721 metadata should be revealed in a way that is not easily gameable with metadata scraping and ERC-20 token transfers.
