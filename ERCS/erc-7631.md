...
Including these methods in the standard will:
- Allow applications to conveniently display the option for users to skip NFTs.
- Help applications avoid situations where the gas costs of automatically transferring multiple ERC-721s exceeds the block gas limit.
