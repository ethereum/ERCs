...
The `mirrorERC721()` and `baseERC2())` methods returning non-zero addresses signal that the ERC-20 and ERC-721 contracts implement the required ERC-7631 interfaces respectively. As such, [ERC-165](./eip-165.md) is not required.
