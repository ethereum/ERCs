...
- [`IIdentityRegistry.sol`](../assets/eip-8354/src/IIdentityRegistry.sol) -- the single [ERC-8004](./eip-8004.md) Identity Registry call the Guard makes, an [ERC-721](./eip-721.md) `ownerOf` read, declared minimally rather than imported, with [`MockIdentityRegistry.sol`](../assets/eip-8354/src/mocks/MockIdentityRegistry.sol) as the test double for the conditional agent-existence check.
