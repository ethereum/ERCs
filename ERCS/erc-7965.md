---
eip: 7965
title: Cryptographic Proof Broadcast in ERC-7786 Gateways
...
This document standardizes these requirements as [ERC-7786] attributes, enabling cryptographic proof-based messaging within the established cross-chain messaging framework.
...
The route MUST form a valid path where each step represents a direct relationship between chains that enables state or transaction verification. Gateways MUST reject messages with invalid or incomplete proof data.
