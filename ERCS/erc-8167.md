...
discussions-to: https://ethereum-magicians.org/t/erc-8167-modular-dispatch-proxies/27781
status: Draft
...
Although selectors are also retrievable by querying `DelegateSet` events, the `selectors` function provides a way to get this information without access to the logs.
...
Existing modular proxies can upgrade to this standard by adding the introspection functions and optionally emitting a `DelegateSet` event for every installed function.

## Reference Implementation

The reference implementation contains three files.

- The [interface](../assets/eip-8167/IERC8167.sol)
- A namespace-based [storage layout](../assets/eip-8167/ProxyStorageBase.sol)
- A [proxy implementation](../assets/eip-8167/Proxy.sol) with delegates for inspection and administration
