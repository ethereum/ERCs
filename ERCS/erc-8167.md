...
Modular designs are also appropriate for personal smart accounts such as [EIP-7702](https://eips.ethereum.org/EIPS/eip-7702) EOAs.
...
This standard improves upon [ERC-2535](./erc-2535.md) in the following ways:
...
- The [interface](../assets/erc-8167/IERC8167.sol)
- A namespace-based [storage layout](../assets/erc-8167/ProxyStorageBase.sol)
- A [proxy implementation](../assets/erc-8167/Proxy.sol) with delegates for inspection and administration
...
The second is to use storage namespaces, such as [ERC-7201](./erc-7201.md) and [ERC-8042](./erc-8042.md).
