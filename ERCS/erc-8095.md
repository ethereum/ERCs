...
* other smart contracts to perform addresses checks within their code possibly using standardized mechanism such as the [ERC-8006](https://github.com/GuardianLabs/ERCs/blob/universal-policy-engine/ERCS/erc-8006.md) being proposed.
...
* **recognized authority**
  - An organisation which is well known by potential users who decides to deploy an [ERC-8095](https://github.com/joseluu/ERCs/blob/master/ERCS/erc-8095.md) contract. Such organisations can be major token issuers, exchanges, state regulators, non profit foundations, industry consortia ...
* **ERC-8095 contract**
