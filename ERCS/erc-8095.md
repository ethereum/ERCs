...
* other smart contracts to perform addresses checks within their code possibly using standardized mechanism such as the ERC-8006 being proposed https://github.com/GuardianLabs/ERCs/blob/universal-policy-engine/ERCS/erc-8006.md
...
* **recognized authority**
  - An organisation which is well known by potential users who decides to deploy an ERC-8095 contract. Such organisations can be major token issuers, exchanges, state regulators, non profit foundations, industry consortia ...
* **ERC-8095 contract**
...
* **on-chain verification**
  ...
  - Such verification can be structured using an ERC-8006 style contract.
* **URI**
...
[IERC8095.sol](../assets/eip-8095/IERC8095.sol)
...
[ERC8095.sol](../assets/eip-8095/ERC8095.sol)
