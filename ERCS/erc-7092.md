...
The existing standard [ERC-3475](erc-3475) that may be used to create abstract storage bonds does not follow same standards as
...
By keeping same standards as with traditional bonds, the [ERC-7092](./erc-7092.md) allows to create a new token for bonds with same caracteristics as traditional bonds so as to make it simple
...
**Every contract compliant with the [ERC-7092](./erc-7092.md) MUST implement the following interface**
...
[ERC-20](erc-20) is motivated by the need to use same the terminology as with traditional bond. Furthermore, by adding the `data` input parameter
...
like [ERC-20](erc-20) or [ERC-1155](erc-1155). The ERC-7092 is a representation of a new token for bonds with all bonds characteristics
...
The reference implementation of the [ERC-7092](./erc-7092.md) can be found [here](../assets/erc-7092/ERC7092.sol).
