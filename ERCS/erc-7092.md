...
### Additional bond parameters and batch functions Interface

The following interface is OPTIONAL and MAY be used to add additional bond characteristics and to allow multiple transactions to be executed in a single batch.
