...
/// @notice For more details, see https://ercs.ethereum.org/ERCS/erc-1820
...
```json
{
        ...
        "output": {
          ...
          "userdoc": {
            ...
            "notice": "This contract is the official implementation of the ERC1820 Registry.For more details, see https://ercs.ethereum.org/ERCS/erc-1820"
          }
        },
        "settings": {
          "compilationTarget": {
