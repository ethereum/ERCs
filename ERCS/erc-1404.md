...
A token claiming [ERC-1404](./eip-1404.md) compliance MUST implement its underlying token interface (for example, [ERC-20](./eip-20.md)) with all functions, events, and semantics unchanged, and MUST additionally implement the following methods.
...
A complete Foundry test suite covering all the cases above is available at [`test/ERC1404.t.sol`](../assets/erc-1404/test/ERC1404.t.sol).
...
| File | Description |
|------|-------------|
| [`src/IERC1404.sol`](../assets/erc-1404/src/IERC1404.sol) | Interface — extends `IERC20` with the two [ERC-1404](./eip-1404.md) functions |
| [`src/ERC1404.sol`](../assets/erc-1404/src/ERC1404.sol) | Concrete implementation — whitelist-based, with [ERC-165](./eip-165.md) support |
| [`test/ERC1404.t.sol`](../assets/erc-1404/test/ERC1404.t.sol) | Foundry test suite covering all mandatory behaviors |
