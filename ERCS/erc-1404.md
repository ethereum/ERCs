...
- MUST, when `spender == from`, return the same code as `detectTransferRestriction(from, to, value)`, since a direct transfer is the degenerate delegated transfer whose initiator is the holder.
