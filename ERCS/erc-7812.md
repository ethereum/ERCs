...
The `EvidenceRegistry` is a singleton contract available at `FIXME` deployed via the "deterministic deployment proxy" from `0x4e59b44847b379578588920ca78fbf26c0b4956c` with the salt `FIXME`. 
...
contract EvidenceRegistry is IEvidenceRegistry, Initializable {
     ...
     * @inheritdoc IEvidenceRegistry
     */
    function getIsolatedKey(address source_ bytes32 key_) public view returns (bytes32) {
