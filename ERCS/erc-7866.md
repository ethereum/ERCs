...
```json
{
  ...
  "properties": {
    ...
    "default_avatar_visibility": {
      "type": "string",
      "enum": ["public", "private"],
      "description": "Default visibility setting for the user's avatar."
    },
    "dapp_avatars": {
      "type": "object",
      "description": "Mapping of DApp addresses to custom avatars and visibility settings.",
      "additionalProperties": {
        ...
        "properties": {
          ...
          "visibility": {
            "type": "string",
            "enum": ["public", "private"],
            "description": "Visibility setting for this DApp-specific avatar."
          }
        },
  ...
  "required": ["username", "avatar", "bio", "website", "socials", "default_avatar_visibility", "dapp_avatars"],
  "additionalProperties": false
}
```

A more simplified format can be:
