...
author: Marco De Rossi <marco@metamask.io>, Davide Crapis (@dcrapis) <davide@ethereum.org>
...
* Use [ERC-721](../eip-721.md) interface for agent minting, ownership and transfer  
* ENS support  
...
*The authors acknowledge Dayan Brunie (Consensys), Sumeet Chougule (Nethermind), Jordan Ellis (Google), Nicola Greco (Deepcrypto), David Minarsch (Olas), Barnabé Monnot (Ethereum Foundation), Regan Peng (PIN AI), David Shi (Operator Labs), Pratyush Ranjan Tiwari (Freysa / Eternis), Nima Vaziri (Eigen Labs), Wilson Chen (TensorBlock), Austin Griffith (Ethereum Foundation) for their technical feedback and contributions.*