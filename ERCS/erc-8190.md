...
The caller MUST have approved the contract to spend at least `amount` of the payment token before calling `open`. Implementations MAY support [ERC-2612](./eip-2612) `permit` to allow gasless approval via signature.
