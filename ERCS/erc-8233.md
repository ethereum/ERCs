...
<img src="../assets/eip-8233/figures/fund-state-machine.svg" alt="Fund state machine" width="600" />
...
MIT/Apache licensed reference implementation is available in the [assets folder](../assets/eip-8233/).
