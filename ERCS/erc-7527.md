...
This proposal outlines interfaces for a Function Oracle Automated Market Maker(FOAMM). A function oracle feeds mint/burn prices based on an embedded equation to FOAMM, which executes and clears the mint and burn of NFT. Based on the pirce feeds of function oracle, FOAMM mints NFT when receiving corresponding amount of ERC-20 or ETH, and FOAMM burns NFT when a corresponding amount of ERC-20 or ETH being withdrawn. 
