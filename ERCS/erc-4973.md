...
To invoke `function give(...)` and `function take(...)` a bytearray signature must be created using [EIP-712](./eip-712.md). A tested reference implementation in Node.js is attached at [index.mjs](../assets/erc-4973/sdk/src/index.mjs), [index_test.mjs](../assets/erc-4973/sdk/test/index_test.mjs) and [package.json](../assets/erc-4973/package.json). In Solidity, this bytearray signature can be created as follows:
