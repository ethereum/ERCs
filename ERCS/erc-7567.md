...
This [standard](https://github.com/adityashukla700/ERCs/edit/master/ERCS/erc-7567.md) is an extension of ERC-721. It proposes splitable utility properties to a NFT, which will allow user to have or trade specific utilities instead of whole set as an NFT. It gives creators ability to add new utility functionality to their tokens.
