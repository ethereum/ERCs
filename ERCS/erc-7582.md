...
![diagram showing basic this proposal flow](../assets/erc-7582/base-flow.svg)
...
This proposal allows for MADV account to specify their own method for extracting the validator address from the `nonce`. This provides flexibility to account developers and supports both just in time validators and storage pattern. 
...
See the [MADV reference implementation](/assets/erc-7582/MADVAccount.sol) for a simple example of how to implement this proposal.
