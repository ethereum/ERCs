...
A direct ERC unlocking standard will help developers who need this scenario build a better relationship of mutual trust with the community. They can no longer make huge profits by overdrafting expected early marketing, especially for tokens with strong backgrounds. Large amounts of funds are often withdrawn from the market through clever and obscure unlocking rules, making it difficult for ordinary users to identify these traps.
