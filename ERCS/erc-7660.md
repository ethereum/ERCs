...
This proposal outlines [ERC-20] tokens which released based on predefined periods controlled by smart contracts,smart contract allows token released based on predefined periods, enabling lock token balances and gradually release tokens.
