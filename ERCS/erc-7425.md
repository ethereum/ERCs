...
interface TokenReserve is ERC4626{
	...
	*/
	...
	/** 
	* @dev Get amount deposited to reserve by owner using optional depositreserve()
	* @param count Number for deposit count
	...
	*/
	...
	/**
	* @dev Amount received for closed proposal by owner
	* @param proposal Proposal number
	* @return Amount of ERC20
	*/
	function closeDeposited(uint256 proposal) external view returns(uint256);
