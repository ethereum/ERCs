...
- **Layer 2 (Verify)**: [ERC-8126](./eip-8126.md) - trust/risk scoring  
...
| 2     | Verify                   | e.g. [ERC-8126](./eip-8126.md) | "Is this agent trustworthy and free of malicious signals?" |
...
- **Privacy** — ERC-8126 risk gating preserves verification without unnecessary exposure  
...
| `allowedContracts`     | `address[]`   | No       | Optional whitelist of target contracts |
| `blockedContracts`     | `address[]`   | No       | Optional blacklist of contracts |
...
| `minVerificationScore` | `uint8`       | No       | Optional minimum ERC-8126 verification score (0 = disabled) |
...
- Separation of concerns: identity ERC-8004 and optional verification decoupled from execution  
- policyHash in [ERC-712](./eip-712.md) signatures binds actions immutably  
