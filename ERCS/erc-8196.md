...
- **Layer 1 (Identify and Verify)**: [ERC-8126](./eip-8126.md) - identification, verification and risk scoring  
- **Layer 2 (Execute)**: [ERC-8196](./eip-8196.md) - policy-bound execution with immutable audit trail
...
|-------|--------------------------|---------------------------|----------------------------------------|
| 1     | Identify and Verify      | [ERC-8126](./eip-8126.md) | "Is this agent trustworthy and free of malicious signals?" |
| 2     | Execute                  | [ERC-8196](./eip-8196.md) | "Is this action authorized right now?" |
...
| `agentId`              | `uint256`     | Yes      | ERC-8126 agent id; key for the ERC-8126 `getLatestRiskScore` lookup |
...
- Separation of concerns: identity and verification (ERC-8126) decoupled from execution, with verification enforced via policy 
