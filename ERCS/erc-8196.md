...
- **Layer 1 (Register)**: [ERC-8004](./erc-8004.md) - on-chain identity and registration  
- **Layer 2 (Verify)**: [ERC-8126](./erc-8126.md) - verification/risk scoring  
...
|-------|--------------------------|---------------------------|----------------------------------------|
| 1     | Register                 | [ERC-8004](./erc-8004.md) | "Does this agent exist on-chain?"      |
| 2     | Verify                   | [ERC-8126](./erc-8126.md) | "Is this agent trustworthy and free of malicious signals?" |
...
This ERC defines an on-chain smart contract interface (`IAIAgentAuthenticatedWallet`). Implementations are expected to be smart contracts (such as [ERC-4337](./erc-4337.md) account abstraction wallets or dedicated policy enforcement modules) that implement this interface.
...
### [ERC-712](https://eips.ethereum.org/EIPS/eip-712) Types
