...
description: Zero-knowledge proof metadata is a standard interface for discovering ZK circuit identifiers, semantic versions, verification keys, and public input schemas.
