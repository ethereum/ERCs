...
5. Compliant contracts SHOULD implement [ERC-165](./erc-165.md) identifier.
...
2. The methods in `IERC_ACL_GENERAL` conform to [ERC-5750](./erc-5750.md) to allow extension.
