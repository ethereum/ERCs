...
The core registration interface extends [ERC-8177](./eip-8177.md) (Blob Space Segments) with a
...
blobs with other protocols, callers needed a separate [ERC-8177](./eip-8177.md) call to declare their
...
[ERC-3722](./eip-3722.md) (Poster) and [ERC-8177](./eip-8177.md): the event log suffices for
