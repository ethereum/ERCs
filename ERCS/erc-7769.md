...
Notice that according to EIP-7702 it is not required to provide the same `eip7702Auth` tuple for any consequent
`UserOperation` as the result of the authorization is stored on-chain.
