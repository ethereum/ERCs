...
description: An interface enabling DeFi protocols to implement verifiable solvency proofs, risk assessment frameworks, and financial health monitoring through smart contracts
...
![risk-thresholds](../assets/erc-7893/risk-thresholds.png)
...
![threshold-levels](../assets/erc-7893/threshold-levels.png)
...
![oracle-integration](../assets/erc-7893/oracle-integration.png)
...
For more details please visit: [Solvency Proof Implementation](../assets/erc-7893/SolvencyProof.sol)
...
[SolvencyProof.sol](../assets/erc-7893/SolvencyProof.sol) provides a complete implementation of the `ISolvencyProof` interface with:
...
[SolvencyProof.test.ts](../assets/erc-7893/SolvencyProof.test.ts) contains an extensive test suite that:
...
For more information please visit: [Test Case Documentation](../assets/erc-7893/full-test-case.md)
