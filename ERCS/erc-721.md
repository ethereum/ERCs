...
1. [ERC-20](./erc-20.md) Token Standard.
1. [ERC-165](./erc-165.md) Standard Interface Detection.
1. [ERC-173](./erc-173.md) Owned Standard.
...
1. [OpenZeppelin `SafeERC20.sol` Implementation](../assets/erc-721/SafeERC20.sol).
