...
Currently, the [ERC-721](./erc-721.md) standard includes a basic metadata extension, which optionally provides functions
...
The metadata format is compatible with the [ERC-721](./erc-721.md) and OpenSea style metadata format.
...
Both the [ERC-721](./erc-721.md) and [ERC-1155](./erc-1155.md) provide natural extension points in the metadata JSON
