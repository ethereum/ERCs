...
1. Pulls and approves [ERC-20](./erc-20.md) amounts to the proxy for a designated spender (approvals),
...
The limitation of this solution is that enforcement is limited to tokenized balances (ETH or [ERC-20](./erc-20.md)) and cannot apply to non-transferable state stored within other contracts, such as staking positions or lending positions.
...
Test Cases can be found [here](../assets/erc-8009/test/BalanceProxy.test.ts).

## Reference Implementation

A reference implementation of the `BalanceProxy` contract can be found [here](../assets/erc-8009/contracts/BalanceProxy.sol).
