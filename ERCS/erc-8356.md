...
subject-less authorship claim, to a C2PA Content Credential so that a viewer can
...
`version: "1"`, with the chain id and verifying contract). It introduces no [ERC-191](./eip-191.md) scheme. The domain
...
EAS attests arbitrary claims, but neither carries a revocable consent that a
