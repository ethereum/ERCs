...
- `structHash`: hashed information for deploying the NFT contract (e.g. name, symbol, admins etc). This corresponds to the value `hashStruct` as defined in the [EIP-712 definition of hashStruct](https://eips.ethereum.org/EIPS/eip-712#definition-of-hashstruct) standard.
