...
The `deposit`, `mint`, `withdraw`, `redeem` methods for [EIP-4626](./erc-4626.md) should revert when the `isLocked` is true to prevent issuing or burning shares with an undefined share price.
