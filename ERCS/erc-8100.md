...
Contracts that implement both ERC-6123 and a *representable contract state* interface (for example,
...
For example, an ERC-6123 implementation that reserves `partId = 1` for its “settlement context”
