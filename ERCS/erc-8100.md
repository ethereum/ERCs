...
- For `address`:
    ...
    - `"address"` → hex with `0x` prefix and [ERC-55](./erc-55.md)  checksum.
...
- The renderer MUST set `evmstate:chain-id` to the [EIP-155](https://eips.ethereum.org/EIPS/eip-155) chain ID, as a base-10 string.
...
- Contracts can implement this interface alongside [ERC-20](./erc-20.md), [ERC-721](./erc-721.md), [ERC-1155](./erc-1155.md), or any other existing standard.
