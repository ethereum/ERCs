...
This standard specifies trust attestation structures, the transitive validation algorithm, ENS integration semantics, and [ERC-8001](./eip-8001) coordination hooks.
...
[EIP-712](./eip-712) domain binding prevents cross-contract replay. Monotonic nonces prevent replay within the same contract.
