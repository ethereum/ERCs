...
Please see [ERC-20 Token Standard](./erc-20.md) for detailed specifications. Do note that these methods and events only work on the "default" class of an MCT.
...
## References
- ERC-20 Token Standard. ./erc-20.md
- ERC-721 Non-Fungible Token Standard. ./erc-721.md
- ERC-1178 Multi-class Token Standard. ./erc-1178.md
