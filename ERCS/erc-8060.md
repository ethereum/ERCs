...
PublicDataProofDemo (https://github.com/buckyos/PublicDataProof)
- A standard reference implementation

DMC public data inscription  (https://github.com/buckyos/DCRM) 
...
- DMC Main Chain (https://www.dmctech.io/)
- CYFS (https://github.com/buckyos/CYFS)
