...
/// @dev See https://ercs.ethereum.org/ERCS/erc-7432
...
this feature MUST also implement the metadata extension of [ERC-721](./erc-721.md). This extension is **optional** and allows
...
The following JSON is an example of [ERC-7432](./erc-7432.md) Metadata:
...
* Compliant contracts SHOULD implement [ERC-165](./erc-165.md).

## Rationale

[ERC-7432](./erc-7432.md) IS NOT an extension of [ERC-721](./erc-721.md). The main reason behind this decision is to
...
Similar to [ERC-721](./erc-721.md), this standard enable other accounts to manage roles on behalf of the NFT owner. This
...
requirement enables dApps to use a standalone [ERC-7432](./erc-7432.md) contract as the authoritative source for the
