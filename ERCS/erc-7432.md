...
this feature MUST also implement the metadata extension of [ERC-721](./erc-721.md) or [ERC-1155](./erc-1155.md). This
...
* Compliant contracts SHOULD support [ERC-165](./erc-165.md).
...
Similar to [ERC-721](./erc-721.md), this standard enables users to approve other accounts to grant and revoke roles on
