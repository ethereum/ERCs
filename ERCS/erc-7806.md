...
## Abstract
This proposal defines interfaces to build intent-centric smart accounts under [7702 Set EOA account code](https://eips.ethereum.org/EIPS/eip-7702), allowing EOA account owners to define their intents of a transaction and let relayers (solvers) to validate and execute the requests.
