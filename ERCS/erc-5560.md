...
The EIP is a Redeemable NFT extension which adds a `redeem` function to [EIP-721](./erc-721.md). It can be implemented when an NFT issuer wants his/her NFT to be redeemed for a physical object.
