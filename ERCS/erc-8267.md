...
Existing standards ([ERC-725](./eip-725.md) and W3C DIDs) address human identity but not AI agent-specific concerns: capability declaration, code auditability, economic staking, and agent-specific reputation. This standard fills that gap.
