...
description: On-chain identity, capability declaration, staking, auditing, and reputation for autonomous AI agents.
author: Panini (@Brooks1003)
discussions-to: https://ethereum-magicians.org/t/erc-agent-identity-standard/9999
status: Draft
...
Existing standards ([ERC-725](./eip-725.md), [ERC-735](https://eips.ethereum.org/EIPS/eip-735), W3C DIDs) address human identity but not AI agent-specific concerns: capability declaration, code auditability, economic staking, and agent-specific reputation. This standard fills that gap.
...
- **Full Repository**: Brooks1003/base-agent-registry
