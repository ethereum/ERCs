...
A signer MAY be specified to provide a signature to process the redemption. If the signer is not the null address, the signature MUST recover to the signer address via [EIP-712](https://eips.ethereum.org/EIPS/eip-712) or [ERC-1271](./eip-1271.md).
