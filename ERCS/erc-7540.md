...
Implementations MUST support overloaded `deposit` and `mint` methods based on the specification from [ERC-4626](./eip-4626.md), with an additional `owner` input of type `address`.
