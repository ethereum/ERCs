...
The Public Non-Fungible Token Emote Repository standard provides an enhanced interactive utility for [ERC-721](./erc-721.md) and [ERC-1155](./erc-1155.md) by allowing NFTs to be emoted at.
...
/// @dev See https://ercs.ethereum.org/ERCS/erc-6381
...
Tests are included in [`emotableRepository.ts`](../assets/erc-6381/test/emotableRepository.ts).

To run them in terminal, you can use the following commands:

```
cd https://ercs.ethereum.org/assets/erc-6381
npm install
npx hardhat test
```
...
See [`EmotableRepository.sol`](../assets/erc-6381/contracts/EmotableRepository.sol).
