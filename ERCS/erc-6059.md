...
The Parent-Governed Nestable NFT standard extends [ERC-721](./erc-721.md) by allowing for a new inter-NFT relationship and interaction.
...
![Nestable tokens](../assets/erc-6059/img/eip-6059-nestable-tokens.png)
...
/// @dev See https://ercs.ethereum.org/ERCS/erc-6059
...
1. **Reject child token**\
![Reject child token](../assets/erc-6059/img/eip-6059-reject-child.png)
2. **Abandon child token**\
![Abandon child token](../assets/erc-6059/img/eip-6059-abandon-child.png)
3. **Unnest child token**\
![Unnest child token](../assets/erc-6059/img/eip-6059-unnest-child.png)
4. **Transfer the child token to an EOA or an `ERC721Receiver`**\
![Transfer child token to EOA](../assets/erc-6059/img/eip-6059-transfer-child-to-eoa.png)
5. **Transfer the child token into a new parent token**\
![Transfer child token to parent token](../assets/erc-6059/img/eip-6059-transfer-child-to-token.png)\
...
Tests are included in [`nestable.ts`](../assets/erc-6059/test/nestable.ts).

To run them in terminal, you can use the following commands:

```
cd https://ercs.ethereum.org/assets/erc-6059
npm install
npx hardhat test
```
...
See [`NestableToken.sol`](../assets/erc-6059/contracts/NestableToken.sol).
