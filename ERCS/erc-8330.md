...
Compliant core oracles MUST implement [ERC-165](./eip-165.md) and return `true`
...
[ERC-4626](./eip-4626.md) defines tokenized vault accounting and conversion
...
[ERC-7540](./eip-7540.md) extends ERC-4626 for asynchronous requests, and
[ERC-7575](./eip-7575.md) supports multi-asset vaults. Both may consume NAV but
