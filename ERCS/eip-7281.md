...
All `XERC20` tokens MUST implement the standard `ERC20` interface. Note that while many of the below functions are inspired by ERC-777, implementers are NOT REQUIRED to adhere to the full ERC-777 specification.
