...
author(s): Nitin Bhagat <bhagatnitin312@gmail.com>, JongWook Bae <bae@cwnu.ac.kr>, Su-Hyun Lee <sleepl@changwon.ac.kr>
...
| Feature                  | [ERC-721](https://eips.ethereum.org/EIPS/eip-721) | [ERC-1155](https://eips.ethereum.org/EIPS/eip-1155) | [ERC-6150](https://eips.ethereum.org/EIPS/eip-6150) | ERC-7891 (Proposed) |
|--------------------------|---------|---------|---------|------------------|
| Unique NFTs              | ✅      | ❌       | ✅       | ✅                |
...
The proposed EIP-7891 extends [EIP-721](https://eips.ethereum.org/EIPS/eip-721) and [EIP-6150](https://eips.ethereum.org/EIPS/eip-6150), making it backward compatible.
