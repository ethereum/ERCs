...
2. Upgrade NFTs into real vault-like containers
   ...
   2. Wallet-agnostic utility – Creators choose any audited [ERC-7579](./eip-7579.md) implementation (Kernel, Nexus, Safe-7579), gaining modular features such as guardians or session keys.
