...
![Sample proxy on Etherscan](../assets/erc-1967/Sample-proxy-on-etherscan.png)
 ...
 * https://ercs.ethereum.org/ERCS/erc-1967[EIP1967], so that it doesn't conflict with the storage layout of the
 ...
 * https://ercs.ethereum.org/ERCS/erc-1967[EIP1967] slots.
 */
