...
interface IERC7858 /**is IERC5007, IERC721 */ {
    enum EXPIRY_TYPE {
...
- `supportInterface` for `IERC7858` is `0xAABBCCDD`  for `IERC7858Epoch` is `0xAABBCCDD`
...
- `totalSupplyAtEpoch` return the total supply at given epoch.
