...
A storage layout file is a JSON object with the following top-level members. See [`storage-layout.schema.json`](../assets/erc-8317/storage-layout.schema.json) for the full JSON Schema, [`example-erc20.json`](../assets/erc-8317/example-erc20.json) for an ordinary sequential layout, and [`example-eip7702-namespaced.json`](../assets/erc-8317/example-eip7702-namespaced.json) for a layout mixing sequential and ERC-7201 namespaced storage.
...
Conditions are JSON Logic expressions. The following variables are available via `{"var": "..."}`:
