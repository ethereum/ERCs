...
- **Solidity contracts**: `src/ZKComplianceVerifier.sol`, `src/ZKComplianceOracle.sol`, `src/SettlementRegistry.sol`, `src/ComplianceTimelock.sol` (Foundry, Solidity 0.8.28, Cancun EVM)
