...
/// @dev See https://ercs.ethereum.org/ERCS/erc-7589
...
this feature MUST also implement the metadata extension of [ERC-1155](./erc-1155.md). This JSON extension is 
...
standardized and secure way for SFT owners to delegate the use of their assets. Through [ERC-7589](./erc-7589.md), users
...
See [`ERC7589.sol`](../assets/erc-7589/ERC7589.sol).
