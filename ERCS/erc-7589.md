...
[ERC-7589](./eip-7589.md) steps in as a solution by introducing the concept of "token commitments". This abstraction
...
for SFTs that can't be modified? [ERC-7589](./eip-7589.md) solves this problem by requiring the `tokenAddress` parameter
...
See [ERC-7589.sol](../assets/eip-7589/ERC7589.sol).
