...
this feature MUST also implement the metadata extension of [ERC-1155](./eip-1155.md). This extension is **optional** and
...
[ERC-7589](./erc-7589.md) IS NOT an extension of [ERC-1155](./eip-1155.md). The main reason behind this decision is to
...
Like [ERC-1155](./eip-1155.md), [ERC-7589](./erc-7589.md) allows users to approve operators to grant and revoke roles on
