...
description: Optional alias metadata extension for ERC-20 tokens
author: SynergeticsAI (@deepu-synergetics) <deepu.tg@webtiga.com>
discussions-to: https://ethereum-magicians.org/t/erc-discussion-agent-alias-metadata-extension-draft/28010
status: Draft
...
Related standards include [ERC-20](./eip-20.md), [ERC-165](./eip-165.md), and [ERC-1046](./eip-1046.md).
