...
## Abstract
It has been a significant challenge for developers attempting to create cloneable and upgradeable contracts on the Ethereum Virtual Machine (EVM). While [ERC-2535](./erc-2535.md) Diamonds and other existing proxy standards offer partial solutions, a comprehensive answer has remained elusive. Our proposal addresses this gap through the introduction of two main features.
...
![Fig. Use Cases](../assets/erc-7546/images/usecases.svg)
...
For instance, the storage could be arranged according to useful storage layout patterns, such as ***[ERC-7201](./erc-7201.md)***.
...
![Fig. Comparison with Diamond](../assets/erc-7546/images/comparison-with-diamond.svg)
...
![Fig. Comparison with Beacon](../assets/erc-7546/images/comparison-with-beacon.svg)
...
- Reference Implementations
  - [Proxy Contract](../assets/erc-7546/src/Proxy.sol)
  - [Dictionary Contract](../assets/erc-7546/src/Dictionary.sol)
- Tests
  - [Proxy Spec Test](../assets/erc-7546/test/Proxy.spec.t.sol)
  - [Dictionary Spec Test](../assets/erc-7546/test/Dictionary.spec.t.sol)
  - [UCS Usecase Test](../assets/erc-7546/test/UCS.usecase.t.sol)
