...
```
The implementation contract MUST implement the function selector to be registered as a key in [the mapping](#for-on-chain-support). Therefore, it is RECOMMENDED to verify this during registration.
