...
A complete reference implementation with a Foundry test suite (including the vectors above and a full lifecycle demo: propose → unanimous accept → append and co-sign records → all-keys delegation with operator writes → leave/dissolve → next-generation recreation) is provided in [`../assets/erc-8344/`](../assets/erc-8344/README.md).
