...
- [IERC-721H.sol](../assets/eip-XXXX/IERC721H.sol) — Core interface (10 functions, 3 events) + optional analytics interface (12 functions)
- [ERC-721HStorageLib.sol](../assets/eip-XXXX/ERC-721HStorageLib.sol) — Low-level storage library
- [ERC-721HCoreLib.sol](../assets/eip-XXXX/ERC-721HCoreLib.sol) — High-level query library
- [ERC-721HFactory.sol](../assets/eip-XXXX/ERC-721HFactory.sol) — Production factory + collection wrapper (companion, not required for EIP compliance)
