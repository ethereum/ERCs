...
Test files are provided in [`../assets/erc-0000/test/`](../assets/erc-0000/test/).

## Reference Implementation

A complete reference implementation is provided in:
- [ERC-721H.sol](../assets/erc-0000/ERC-721H.sol) — Core contract (v2.0.0)
- [IERC-721H.sol](../assets/erc-0000/IERC-721H.sol) — Core interface (10 functions, 3 events) + optional analytics interface (12 functions)
- [ERC-721HStorageLib.sol](../assets/erc-0000/ERC-721HStorageLib.sol) — Low-level storage library
- [ERC-721HCoreLib.sol](../assets/erc-0000/ERC-721HCoreLib.sol) — High-level query library
- [ERC-721HFactory.sol](../assets/erc-0000/ERC-721HFactory.sol) — Production factory + collection wrapper (companion, not required for EIP compliance)
