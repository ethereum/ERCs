...
Test files are provided in [the test directory](https://github.com/emilianosolazzi/EIP-721H/tree/main/tests).

## Reference Implementation

A complete reference implementation is provided in:
- [ERC-721H.sol](https://github.com/emilianosolazzi/EIP-721H/blob/main/ERC-721H.sol) — Core contract (v2.0.0)
- [IERC-721H.sol](https://github.com/emilianosolazzi/EIP-721H/blob/main/interface/IERC-721H.sol) — Core interface (10 functions, 3 events) + optional analytics interface (12 functions)
- [ERC-721HStorageLib.sol](https://github.com/emilianosolazzi/EIP-721H/blob/main/libraries/ERC-721HStorageLib.sol) — Low-level storage library
- [ERC-721HCoreLib.sol](https://github.com/emilianosolazzi/EIP-721H/blob/main/libraries/ERC-721HCoreLib.sol) — High-level query library
- [ERC-721HFactory.sol](https://github.com/emilianosolazzi/EIP-721H/blob/main/ERC-721HFactory.sol) — Production factory + collection wrapper (companion, not required for EIP compliance)
