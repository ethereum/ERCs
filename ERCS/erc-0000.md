...
## ERC-721(./erc-721.md) Compatibility

This standard is designed to be backwards compatible with existing ERCs, particularly ERC-721(./erc-721.md), to ensure interoperability with existing tools and platforms.
