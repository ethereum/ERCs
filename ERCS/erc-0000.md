...
- [Full test suite](../assets/eip-0000/test/ERC721H_Full.t.sol) — Core Layer 1/2/3, burn, ERC-165, pagination
- [Analytics test suite](../assets/eip-0000/test/ERC721H_FullTest.t.sol) — Analytics extension, provenance, early adopter
- [Gas benchmark tests](../assets/eip-0000/test/ERC721H_Gas.t.sol) — Gas benchmarks vs baseline ERC-721
- [Sybil guard tests](../assets/eip-0000/test/ERC721H_Sybil.t.sol) — Intra-TX and inter-TX Sybil guards
- [Economic fuzz tests](../assets/eip-0000/test/ERC721H_EconomicFuzz.t.sol) — Fuzz testing and economic attack scenarios
