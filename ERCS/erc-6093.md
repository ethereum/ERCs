...
This EIP defines a standard set of custom errors for commonly-used tokens, which are defined as [ERC-20](./erc-20.md), [ERC-721](./erc-721.md), and [ERC-1155](./erc-1155.md) tokens.
...
However, [ERC-20](./erc-20.md), [ERC-721](./erc-721.md), [ERC-1155](./erc-1155.md) were already finalized when custom errors were released, so no errors are included in their specification.
...
/// @dev See https://ercs.ethereum.org/ERCS/erc-20
///  https://ercs.ethereum.org/ERCS/erc-6093
...
/// @dev See https://ercs.ethereum.org/ERCS/erc-721
///  https://ercs.ethereum.org/ERCS/erc-6093
...
/// @dev See https://ercs.ethereum.org/ERCS/erc-1155
///  https://ercs.ethereum.org/ERCS/erc-6093
