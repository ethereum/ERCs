...
interface IAgentVerifier {
    ...
    ///                   (e.g. ERC-8183 jobId, ERC-8275 periodId).
...
#### WYRIWE — Input Provenance (ERC-8299)
...
**Triple-hash chain** (normative in ERC-8299):
...
Once the anchor leg posts, all four layers (ERC-8004 identity, ERC-8299 provenance, ERC-8274 judgment, ERC-8263 anchor) are satisfied by a single production entry.
