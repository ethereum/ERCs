...
author: JimmyShi22 (@JimmyShi22) <jimmyshixiang22@gmail.com>, Damonzwicker (@damonzwicker), TMerlini (@Echo-Merlini)
...
Once the anchor leg posts, all four layers (ERC-8004 identity, WYRIWE provenance, ERC-8274 judgment, proof anchoring) are satisfied by a single production entry.
...
3. The pre-outcome timestamp MUST be anchored at issue time to a system the validator does not control (the same primitive as OCP's observation commitment).
