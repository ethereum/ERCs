...
ERC-8299 (WYRIWE — What You Run Is What You Execute) fills this gap with a three-commitment scheme:
...
Proof anchoring fills this gap: agents anchor a `proofHash` on-chain at inference time via ERC-8263 (Onchain Proof Layer). Consumers requiring proof binding SHOULD verify the anchor alongside `verify()`.
