...
For more background, refer to [EIP-137](./erc-137.md).
...
- [EIP-137](./erc-137.md) outlines the initial implementation of the Registry Contract (ENS.sol) and associated Resolver contracts.
