...
1. Any compliant contract MUST implement [ERC-721](./erc-721.md), and [ERC-165](./erc-165.md).
...
1. We only support [ERC-721](./erc-721.md) NFTs for simplicity and gas efficiency. We have not considered other ERCs, which can be left for future extensions. For example, [ERC-20](./erc-20.md) and [ERC-1155](./erc-1155.md) were not considered.
...
The ERC is designed as an extension of [ERC-721](./erc-721.md) and therefore compliant contracts need to fully comply with [ERC-721](./erc-721.md).
