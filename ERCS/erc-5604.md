...
1. Any compliant contract MUST implement [EIP-721](./erc-721.md), and [EIP-165](./erc-165.md).
...
1. We only support [EIP-721](./erc-721.md) NFTs for simplicity and gas efficiency. We have not considered other EIPs, which can be left for future extensions. For example, [EIP-20](./erc-20.md) and [EIP-1155](./erc-1155.md) were not considered.
