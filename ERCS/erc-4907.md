...
### Contract Interface
Solidity Interface with NatSpec & OpenZeppelin v4 Interfaces (also available at [`IERC4907.sol`](../assets/erc-4907/contracts/IERC4907.sol)):
...
### Test Contract
`ERC4907Demo` Implementation: [`ERC4907Demo.sol`](../assets/erc-4907/contracts/ERC4907Demo.sol)
...
### Test Code
[test.js](../assets/erc-4907/test/test.js)
...
Implementation: [`ERC4907.sol`](../assets/erc-4907/contracts/ERC4907.sol)
```solidity
// SPDX-License-Identifier: CC0-1.0
pragma solidity ^0.8.0;
