...
description: The proxy that if called by its deployer, delegates to the address passed to it in the calldata.
author: Igor Żuk (@CodeSandwich)
discussions-to: https://ethereum-magicians.org/t/eip-puppet-proxy-contract/18482
status: Draft
