...
interface IERC7586 /** is ERC20 */ {
    ...
    */
    ...
    /**
    *  @notice Terminates the swap contract. It is RECOMMENDED to integrate a multisig process to terminate the swap contract.
    *          Both the payer and the receiver MUST sign for the termination to be successful
    */
    function terminateSwap() external returns(bool);
