...
This specification maintains backwards compatibility with existing [EIP-712] implementations across the Ethereum ecosystem, with wallets being able to identify ERC-7803 encoded signatures through the `\x19\x02` prefix while standard [EIP-712] signatures using `\x19\x01` continue to function normally.
