...
according to [EIP-191](./erc-191.md), with the *version
...
- The signTypedData [EIP-712](https://eips.ethereum.org/EIPS/eip-712) has many parallels to what this EIP aims to solve
...
All signatures for messages are generated using [EIP-191](./erc-191.md)
