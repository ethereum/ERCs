...
Clear signing [EIP-4337](./eip-4337.md) User Operations is supported using the `PackedUserOperation` EIP-712 signature format. See [example-userops-eip712.json](../assets/eip-7730/example-userops-eip712.json) for a reference implementation.
