...
| `expectedValue` | Yes | Value of the slot at descriptor authoring time, 0x-prefixed hex, up to 32 bytes. Wallets MUST verify the live slot value matches this before applying the descriptor's formatting. |
