...
In the sample EIP-712 message included in the specification [here](https://github.com/ethereum/EIPs/blob/f3deac81cfe9806b5d742e37c0178801b73c040f/assets/eip-712/Example.js), the schema for the message would be the following json. Note the inclusion in an array, since a single ERC-7730 can describe multiple messages.
