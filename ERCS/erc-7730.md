...
The current version of the specification is 1 at the time of writing. The reference schema for version 1 is [erc7730-v1.schema.json](../assets/eip-7730/erc7730-v1.schema.json).
...
| [example-erc20.json](../assets/eip-7730/example-erc20.json) | Simple example of defining an interface for ERC-20 contracts |
| [example-include.json](../assets/eip-7730/example-include.json) | Example of including an interface into another ERC-7730 file |
| [example-eip712.json](../assets/eip-7730/example-eip712.json) | Clear signing EIP-712 example |
