...
[EIP-7702](./eip-7702.md) lets an externally-owned account (EOA) install a delegation indicator (`0xef0100 || <delegate_address>`) that causes the EVM to execute the delegate's code in the EOA's context when the EOA is called. Two cases arise for ERC-7730 wallets:
