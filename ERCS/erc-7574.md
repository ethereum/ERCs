...
NFT metadata structured according to the  [ERC-721](./erc-721.md) metadata standard is as follows.
...
Implementations of this ERC MUST ensure that issued SBTs are non-transferable and MUST implement [ERC-5192](./erc-5192.md) (Locked SBT).
