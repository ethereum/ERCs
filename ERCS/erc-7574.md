...
NFT metadata structured by the official [ERC-721](./erc-721.md) metadata standard or the Enjin Metadata suggestions are as follows referring to OpenSea docs.
