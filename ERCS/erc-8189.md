...
discussions-to: https://ethereum-magicians.org/t/nft-transfer-with-signature/27312
status: Draft
...
Existing ERC-7564 implementations remain valid. Clients SHOULD feature-detect permit support by checking for `IERC8189` via [ERC-165](./eip-165.md) or probing the new function selectors.
