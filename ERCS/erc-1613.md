...
description: A Gas Station Network allowing smart contracts to accept collect-calls, enabling gasless transactions by paying for gas.
...
The Gas Station Network (GSN) makes smart contracts accessible to non-ether users by allowing contracts to accept "collect-calls", paying for incoming calls. 
