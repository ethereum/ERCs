...
description: A Gas Station Network allowing smart contracts to accept collect-calls, paying for incoming transactions to enable gasless user interactions.
...
A working implementation of the [**gas stations network**](https://github.com/tabookey-dev/tabookey-gasless) consists of `RelayHub`, `RelayRecipient`, `web3 hooks`, an implementation of a gas station inside `geth`, and sample dapps using the gas stations network.
