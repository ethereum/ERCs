...
This ERC conforms to [ERC-7846](./erc-7846.md) which includes [ERC-5792](./erc-5792.md) capabilities specification and introduces two new capabilities for `wallet_connect`. 
