...
This ERC conforms to [ERC-7846](https://eips.ethereum.org/EIPS/eip-7846) which includes [ERC-5792](https://eips.ethereum.org/EIPS/eip-5792) capabilities specification and introduces two new capabilities for `wallet_connect`. 
