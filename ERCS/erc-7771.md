...
The apparent inefficiency of forwarding the call twice is compensated by the router’s hardcoded lookup table efficiency and the use of UUPS proxies (Universal Upgradeable Proxy Standard, EIP-1822).
