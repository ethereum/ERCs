...
[the machine-readable test vector](../assets/erc-draft_agent_memory_state/test-vectors-v1.json).

## Reference Implementation

The reference implementation contains a Solidity registry
([`AgentMemoryStateRegistry.sol`](../assets/erc-draft_agent_memory_state/AgentMemoryStateRegistry.sol),
implementing [`IAgentMemoryState.sol`](../assets/erc-draft_agent_memory_state/IAgentMemoryState.sol)),
