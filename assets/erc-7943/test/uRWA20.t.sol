...
contract uRWA20Test is Test {
    ...
    function test_Revert_Mint_ToNonWhitelisted() public {
        vm.prank(minter);
        vm.expectRevert(abi.encodeWithSelector(IERC7943Fungible.ERC7943CannotReceive.selector, nonWhitelistedUser));
    ...
    function test_Revert_Burn_CannotSend() public {
        ...
        vm.prank(burner);
        vm.expectRevert(abi.encodeWithSelector(IERC7943Fungible.ERC7943CannotSend.selector, burner));
        token.burn(BURN_AMOUNT);
    }
    ...
    function test_Revert_Transfer_FromCannotSend() public {
        ...
        vm.prank(user1);
        vm.expectRevert(abi.encodeWithSelector(IERC7943Fungible.ERC7943CannotSend.selector, user1));
